...
| ----------- | ----------- | ---------- | ---------- | ---------- |
| Acrobat Sign | Abril de 2026 | [Configurar e administrar Modificar Contrato](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/configure-modify-agreement){target="_blank"} | Vídeo | Saiba como configurar e administrar o Modificar contrato no Acrobat Sign. Defina políticas para que as alterações pós-envio permaneçam controladas e auditáveis. |
| Acrobat Sign | Abril de 2026 | [As seleções necessárias do guia com grupos de caixas de seleção](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/checkbox-groups){target="_blank"} | Vídeo | Saiba como usar grupos de caixas de seleção em formulários do Acrobat Sign. Controlar seleções mínimas e máximas para que os signatários atendam às suas regras de opção necessárias. |
| Acrobat Sign | Abril de 2026 | [Modificar um documento depois de enviar](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/modify-in-flight){target="_blank"} | Vídeo | Saiba como corrigir um contrato enviado no Acrobat Sign sem cancelar a transação. Corrija erros e mantenha as assinaturas e as trilhas de auditoria intactas. |
...
| AEM Sites Optimizer | Abril de 2026 | [avaliação do Sites Optimizer](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/documentation/trial){target="_blank"} | Vídeo | Saiba mais sobre a versão de avaliação do AEM Sites Optimizer para clientes existentes da AEM Sites. Veja como ativar a avaliação e começar a revisar oportunidades de otimização de site. |
| AEM Sites Optimizer | Abril de 2026 | [Oportunidade de texto alternativo ausente](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/documentation/opportunities/missing-alt-text){target="_blank"} | Vídeo | Saiba como encontrar texto alternativo de imagem ausente no AEM Sites baseado no Editor de páginas. Melhore a acessibilidade e o envolvimento usando recomendações e correções do Sites Optimizer. |
| AEM Sites Optimizer | Abril de 2026 | [Oportunidades do Core Web Vitals](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/documentation/opportunities/core-web-vitals){target="_blank"} | Vídeo | Saiba como identificar problemas do Core Web Vitals no AEM Sites baseado no Editor de páginas. Aplicar a orientação do Sites Optimizer para ajustar o desempenho e proteger as pontuações de UX. |
| AEM Sites Optimizer | Abril de 2026 | [Oportunidades de backlinks desfeitos](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/documentation/opportunities/broken-backlinks){target="_blank"} | Vídeo | Saiba como detectar backlinks com falha no AEM Sites baseado no Editor de páginas. Resolva problemas de link de entrada para proteger SEO, tráfego e caminhos de navegação do visitante. |
...
| Adobe Experience Manager | Maio de 2026 | [Configurar habilidades do agente do AEM](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/ai/ai-assisted-development/setup/agent-skills){target="_blank"} | Vídeo | Saiba como configurar as Habilidades do agente do AEM para o desenvolvimento assistido por IA no Experience Manager. Siga os pré-requisitos, a configuração e as verificações para habilitar o fluxo de trabalho. |
...
| Adobe Experience Manager | Abril de 2026 | [Visão geral do desenvolvimento assistido por IA](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/ai/ai-assisted-development/overview){target="_blank"} | Artigo | Saiba mais sobre o desenvolvimento de AEM assistido por IA usando um IDE de IA, agentes, AGENTS.md, Habilidades do agente e MCP. Enviar código pronto para produção no AEM as a Cloud Service. |
...
| Adobe Workfront | Abril de 2026 | [Rastreamento de Projeto Mestre com Linhas de Base, Instantâneos e Relatórios Automatizados](https://experienceleague.adobe.com/en/docs/workfront-learn/tutorials-workfront/manage-work/intermediate-projects/baselines-snapshots-and-automated-reports){target="_blank"} | Vídeo | Saiba mais sobre o rastreamento histórico do Workfront além das visualizações em tempo real. Compare o trabalho ao longo do tempo com linhas de base, instantâneos e emails automatizados de relatórios de tarefas. |
