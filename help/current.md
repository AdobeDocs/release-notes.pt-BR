...
**Anúncio do Adobe CX Enterprise:** O Adobe Experience Cloud agora é o [Adobe CX Enterprise](https://business.adobe.com/). Você continuará a ver o _Experience Cloud_ na documentação do produto e nos vídeos do Experience League até concluirmos as atualizações.
...
| [!DNL Experience Cloud] | [Consumo de créditos de AI e trabalhos do agente](https://experienceleague.adobe.com/en/docs/core-services/interface/features/ai-credit-consumption){target="_blank"} | Saiba mais sobre tarefas de agente e taxas de consumo de crédito de IA em aplicativos do CX Enterprise. | 3 de março de 2026 |
