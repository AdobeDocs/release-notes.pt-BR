---
title: Notas de versão centrais — Fevereiro de 2025
...
* **Deixar feedback:** Procure por **_Este conteúdo foi útil?_** na parte inferior de cada artigo ou vídeo. Seus comentários são editados e entregues aos autores de conteúdo.
...
|---------|----|----|-----------|
| Janeiro de 2025 | [Resolver discrepâncias da interface do fluxo de dados de transmissão na  [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25576) | Novo artigo | Saiba como resolver discrepâncias na interface do fluxo de dados, como durações de processamento imprecisas e status de ingestão incorretos na [!DNL AEP]. |
...
| -----------| ---------- | ---------- | ---------- |
|January 2025|[Adobe [!DNL Analytics] & CJA: Quick Start for Basic to Intermediate Analysis Capabilities](https://experienceleague.adobe.com/pt-br/docs/events/adobe-customer-success-webinar-recordings/2024/basic-to-intermediate-analysis-capabilities)|Event |Learn about Adobe [!DNL Analytics] and [!DNL Customer Journey Analytics] with a focus on basic to intermediate analysis capabilities.|
|January 2025|[AEP Web SDK Troubleshooting, Assurance, and Tips and Tricks](https://experienceleague.adobe.com/pt-br/docs/events/tech-sessions/2024/rtcdp-office-hours-2024/aep-web-sdk-troubleshooting)|Event |Gain insights into troubleshooting, assurance, and tips and tricks for the Adobe [!DNL Experience Platform] (AEP) Web SDK.| 
-->
...
Novo vídeo e tutoriais escritos do [!DNL Experience Manager as a Cloud Service] publicados.
...
|September 2024|[Marketo Measure Ultimate overview](https://experienceleague.adobe.com/pt-br/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview)|New video |Learn how Marketo Measure Ultimate allows B2B marketers to gather data from almost any source, including multiple sources of the same type, for thorough attribution. |
|September 2024|[API Help - How to set the Access token in a variable](https://experienceleague.adobe.com/pt-br/docs/marketo-learn/tutorials/integrations/api-set-access-token-variable)|New video |Learn how to set up the Postman application and leverage variables to save data into the variable for reusability purposes. You will also learn how to make your first Marketo Engage REST API call to get the access token.|
|September 2024|[Go live with Dynamic Chat in just 15 minutes](https://experienceleague.adobe.com/pt-br/docs/marketo-learn/tutorials/dynamic-chat/go-live-in-15-minutes)|New video |Watch a step by step guide to help you go live with your first dialogue using Dynamic Chat in just 15 minutes.| 
-->
...
sexta-feira, 5 de dezembro de 2024
