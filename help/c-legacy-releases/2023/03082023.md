...
Data de lançamento: **quinta-feira, 8 de março de 2023**
...
| Março de 2023 | [Introdução ao uso da malha de API](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-developer-app-builder/api-mesh/getting-started-api-mesh.html?lang=pt-BR) | Vídeo | Descubra como usar a malha de API no Adobe Commerce e no Adobe App Builder. Saiba como instalar o Adobe App Builder, trabalhar em projetos, criar um proxy reverso de GraphQL e muito mais. |
...
| Recurso | Descrição |
| ------- | ----------- |
| [!UICONTROL Campanhas] | (Campanhas de público-alvo do [!DNL Microsoft Advertising]; recurso beta aberto; versão de 18 de março) As campanhas de público-alvo agora podem usar a estratégia de lance de CPC (eCPC) aprimorado. Você pode definir lances nas configurações de grupos de anúncios secundários.<br><br>As campanhas de público-alvo com eCPC podem ser incluídas em portfólios para otimização. |
