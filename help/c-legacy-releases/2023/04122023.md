---
title: Notas de versão centrais — Abril de 2023
...
Atualizado em: **quinta-feira, 19 de abril de 2023**
...
| Publicado | Tipo | Recurso do produto | Descrição | Aplicativo |
| -----------| ---------- |---------- |---------- |--------- |
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Março de 2023 | [Atualizar “Somente estrutura” não atualiza o conteúdo de uma cópia no idioma de destino](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21708.html?lang=pt-BR) | Novo artigo | Saiba como resolver o problema em que atualizar _Somente estrutura_ não atualiza o conteúdo de uma cópia no idioma de destino. |
