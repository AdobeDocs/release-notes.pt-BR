...
* **Experience Manager as a Cloud Service**
  ...
  Assista ao [vídeo de visão geral da versão de maio de 2022](https://video.tv.adobe.com/v/3453438/?captions=por_br&quality=12) para obter um resumo dos recursos adicionados à versão 2022.5.0 (maio de 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
