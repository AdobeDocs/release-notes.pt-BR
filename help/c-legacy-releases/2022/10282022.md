---
title: Notas de versão centrais - novembro de 2022
...
>[!IMPORTANT]
>
>Verifique com frequência para ficar por dentro do que está acontecendo na Experience League. A próxima atualização prioritária de produto será implantada em **janeiro de 2023**, após a temporada de festas. Fique atento.
...
Versão mais recente: **quinta-feira, 23 de novembro de 2022**
...
* Oferece personalização e segmentação avançadas, graças à [inserção de variáveis do Campaign](https://github.com/adobe/aem-core-email-components/wiki/RTE-Personalization) na maioria dos campos de caixa de diálogo e ao [componente de segmentação](https://github.com/adobe/aem-core-email-components/wiki/) flexível.
...
| Novembro de 2022 | [Componentes principais do AEM-CIF e integração com a Experience Platform](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/integrations/aep.html?lang=pt-BR) | Vídeo | Saiba como enviar dados do evento da vitrine de uma página do produto renderizada pelo AEM para a Experience Platform usando o Conector CIF - Experience Platform. | AEM CS |
