...
| Maio de 2022 | [Programar uma solicitação do Report Builder](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/schedule-a-report-builder-request.html) | Vídeo | Saiba como configurar um cronograma básico para uma pasta de trabalho do Report Builder. |
