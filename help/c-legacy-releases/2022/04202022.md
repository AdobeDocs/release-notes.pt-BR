...
* **Experience Manager as a Cloud Service**
  ...
  Assista ao vídeo [Visão geral da versão de março de 2022](https://video.tv.adobe.com/v/3454201?captions=por_br) para obter um resumo dos recursos adicionados à versão 2022.3.0 (março de 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
