...
Lançamento planejado para: **quinta-feira, 24 de agosto de 2022**
...
* A [entrega de imagem otimizada para a Web](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/web-optimized-image-delivery.html) do Experience Manager as a Cloud Service melhora significativamente a velocidade de carregamento da página ao fornecer formatos como o WebP. Esse novo serviço também oferece opções mais flexíveis de redimensionamento e transformação de imagens. Todas as versões do [Componente de imagem principal](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/image.html) usam este serviço e permitem entregar imagens em WebP por meio de uma opção na política do componente de imagem.
...
* `mod_macro` agora está disponível no Experience Manager as a Cloud Service. [Consulte esta tabela](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html?lang=pt-BR) para obter uma lista de módulos Apache suportados.
...
| Agosto de 2022 | [Tutoriais do AEM Headless](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html) | Artigos atualizados | Os tutoriais do AEM Headless SDK foram atualizados para usar consultas persistentes e o WKND 2.0. Use tutoriais práticos para explorar como usar as várias opções e escolher a mais certa para você. | AEM as a Cloud Service |
