...
* [Interface da Experience Cloud e serviços principais](#ecloud) (data de adição: **26 de fevereiro de 2020**)
...
* **Laboratórios (Visualizações de tecnologia):** esse novo recurso do Analytics permite que você teste protótipos de novos recursos na produção e forneça comentários importantes para a Adobe. [Saiba mais...](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html)
...
* O **Workspace debugger** foi adicionado ao menu Ajuda, fornecendo uma maneira mais simples de habilitá-lo para depurar solicitações do Workspace. [Saiba mais...](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/reporting-tricks.md)
...
| Alteração futura em relação ao campo `createDate` para usuários do Analytics | 30 de agosto de 2019 | Em outubro ou novembro de 2019, o campo `createDate` para os usuários do Analytics foi atualizado da Hora do Pacífico dos EUA para um valor de data/hora corretamente formatado com as informações de fuso horário.(AN-183468) |
...
* Correção de um erro que resultava na quebra da interface do usuário pelo fluxo de criação de destino para a seleção de Contas integradas (AAM-52414).
...
* Correção de um erro que resultava em não salvamento da Exportação de dados ao salvar os Controles de exportação de dados em destinos novos ou existentes para clientes que usam a integração da Adobe Experience Platform (AAM-52814).
...
Consulte [Gerar várias comunicações interativas usando a API em lote](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/generate-multiple-interactive-communication-using-batch-api.html).

* **Plataformas compatíveis com AEM Forms no JEE**

  Adição de suporte ao Oracle 19c para AEM Forms em clientes JEE.
Consulte [plataformas compatíveis para AEM Forms no JEE](https://experienceleague.adobe.com/docs/experience-manager-65/forms/install-aem-forms/jee-installation/aem-forms-jee-supported-platforms.html).
...
* [Atualização 19.2.3 do Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-2.html)
