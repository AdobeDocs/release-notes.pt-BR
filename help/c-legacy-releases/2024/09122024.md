...
Lançamento: **terça-feira, 19 de agosto de 2024**
...
| Outubro de 2 | Página inicial personalizável | Na página de aterrissagem do Experience Cloud, clique em **[!UICONTROL Editar]**. [!UICONTROL O modo de edição &#x200B;] permite que você personalize sua página inicial do Experience Cloud com acesso a uma biblioteca de widgets e planos de fundo personalizados. [!UICONTROL O modo Editar] fornece controles intuitivos e perfeitos para mover, redimensionar e gerenciar widgets, incluindo ações em massa e ajustes de layout, oferecendo uma experiência mais estética e personalizada. Otimize sua página inicial do Experience Cloud com acesso a uma biblioteca de widgets e planos de fundo personalizados. |
...
* [Notas de versão](https://experienceleague.adobe.com/pt-br/docs/analytics/release-notes/latest) do [!DNL Analytics] <!-- * [!DNL Analytics] [release notes](https://experienceleague-review.corp.adobe.com/docs/analytics/release-notes/latest.html)  -->
