...
| ----------| ---------- | ---------- | ---------- |---------- |
| Dezembro de 2023 | SDK móvel | [Tutorial: Implementar a Adobe Experience Cloud em aplicativos para dispositivos móveis](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/overview) | Tutorial atualizado (vários artigos) | Aprenda como implementar aplicativos da Adobe [!DNL Experience Cloud] em seu aplicativo móvel usando o Adobe [!DNL Experience Platform Mobile SDK]. |
| Dezembro de 2023 | Platform, Journey Optimizer | [Criar e enviar notificações por push](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push) | Artigo | Aprenda como criar notificações por push para aplicativos móveis com o [!DNL Experience Platform Mobile SDK] e o [!DNL Journey Optimizer]. |
| Dezembro de 2023 | SDK móvel, Journey Optimizer | [Criar e enviar mensagens no aplicativo](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp) | Artigo | Aprenda como criar mensagens em aplicativos móveis com o [!DNL Experience Platform Mobile SDK] e o [!DNL Journey Optimizer]. |
| Dezembro de 2023 | Platform, Journey Optimizer | [Criar e exibir ofertas com a Gestão de decisões](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers) | Artigo | Saiba como mostrar ofertas da [!UICONTROL Gestão de decisões] do [!DNL Journey Optimizer] em seus aplicativos móveis com o [!DNL Experience Platform Mobile SDK]. |
| Dezembro de 2023 | Administração | [Adicionar admins de produto](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/admin/add-product-administrators) | Vídeo | Aprenda como adicionar novos(as) admins da Adobe [!DNL Experience Platform] no [!DNL Admin Console]. Admins podem adicionar e gerenciar outros(as) admins, usuários, desenvolvedores e credenciais de API. |
...
| Dezembro de 2023 | Administração | [Adicionar usuários e gerenciar permissões](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/admin/add-users) | Vídeo atualizado | Saiba como adicionar usuários e gerenciar permissões em aplicativos baseados na Adobe Experience Platform, como a [!DNL Real-Time Customer Data Platform] e o [!DNL Journey Optimizer]. |
| Dezembro de 2023 | Coleção de dados | [Criar uma sequência de dados](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream) | Vídeo | Saiba como criar uma sequência de dados na Experience Platform. |
| Dezembro de 2023 | Coleção de dados | [Configurar uma propriedade de tag](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags) | Vídeo | Aprenda a configurar uma propriedade de tag na interface da [!UICONTROL Coleção de dados]. |
...
| Dezembro de 2023 | Perfis | [Criar um atributo computado para a soma das compras](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases) | Vídeo | Aprenda a usar atributos computados para somar os valores de compras feitas por um usuário em vários canais de vendas. |
...
|---------|----|----|-----------|
| Dezembro de 2023 | [[!DNL AEP]  - Públicos-alvo do  [!DNL TARGET] : alterações de data exibidas a todos os públicos-alvo do  [!DNL Target]  após uma única ativação na  [!DNL AEP]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23223) | Novo artigo | Descubra o motivo que causa a exibição da data alterada em todos os segmentos ativados no destino do [!DNL Target] da [!DNL Adobe Experience Platform] (no [!DNL Target UI]) após a ativação de um único segmento. |
| Dezembro de 2023 | [[!DNL AEP]  - As atualizações do perfil de transmissão falham quando o esquema de origem não é compatível com [!DNL XDM]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23026) | Novo artigo | Saiba mais sobre a falha no fluxo de dados do perfil de transmissão “[!DNL upsert]”, que ocorre quando o esquema de origem não é compatível com [!DNL XDM]. |
| Dezembro de 2023 | [[!DNL AEP]  - O público-alvo endereçável na seção de uso da licença não corresponde à contagem de perfis da página inicial](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23025) | Novo artigo | Saiba mais sobre o problema no qual o público-alvo endereçável da seção de uso da licença não corresponde à contagem de perfis da página inicial. |
...
| Publicado | Nome | Tipo | Descrição |
| ----------| ---------- | ---------- |---------- |
| Dezembro de 2023 | [Importar dados de amostra para a Adobe  [!DNL Experience Platform]](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/import-sample-data) | Artigo atualizado | Saiba como configurar um ambiente de sandbox da Experience Platform com dados de amostra. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Janeiro de 2024 | [Compartilhar um projeto somente leitura no [!UICONTROL Analysis Workspace]](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/view-only-projects-in-analysis-workspace) | Vídeo | Saiba como compartilhar projetos somente leitura do [!UICONTROL Workspace] com os usuários e entenda os recursos disponíveis para esse nível de permissão. |
| Dezembro de 2023 | [Uma lista de verificação útil para a auditoria do dicionário de dados](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/administration/admin-tips/audit-your-data-dictionary) | Artigo | Aumente a eficiência e a confiabilidade dos dados com nossa lista de verificação de auditoria do [!UICONTROL dicionário de dados] do Adobe [!DNL Analytics] e [!DNL Customer Journey Analytics]. |
...
| Dezembro de 2023 | [Configuração básica da extensão do Analytics nas tags da Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/basic-configuration-of-the-analytics-launch-extension.html) | Vídeo | Veja como configurar a extensão do [!DNL Analytics] nas tags da [!DNL Experience Platform] para um site básico. |
| Dezembro de 2023 | [Configurar o gerenciamento de biblioteca para a extensão do Analytics no Adobe Tags](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/configuring-library-management-in-the-launch-analytics-extension.html) | Vídeo | Saiba mais sobre as opções de configuração do gerenciamento de biblioteca para a extensão do [!DNL Analytics] nas tags da Experience Platform, incluindo a seleção de conjuntos de relatórios para coleta de dados. |
| Dezembro de 2023 | [Definir configurações de variáveis globais para a extensão do Analytics nas tags da Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/configuring-global-variables-in-the-tags-analytics-extension.html) | Vídeo | Saiba como definir as configurações de variáveis globais na extensão de tags do Analytics para um site básico. |
...
Você pode usar o [serviço de dados Real User Monitoring (RUM)](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/content-requests?lang=pt-BR) para habilitar a coleta de dados de cliente no AEM as a Cloud Service.
...
* [As permissões personalizadas do Cloud Manager](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-permissions) possibilitam criar perfis de permissões personalizadas com permissões configuráveis para restringir o acesso a programas, pipelines e ambientes para usuários do [!DNL Cloud Manager].
...
* Os containers de build agora são compatíveis com o Node.js versão 18 para[&#x200B; pipelines de front-end](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/developing/developing-with-front-end-pipelines).
* Para programas recém-criados do Cloud Manager,[&#x200B; a subconta associada da New Relic](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/user-access-new-relic) não está ativada por padrão.
...
* As implementações de atualizações para o [ambiente de build](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details) que foram [anunciadas e iniciadas com a versão de outubro de 2023 do Cloud Manager](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/cloud-manager/2023/2023-10-0) foram concluídas.
  * O suporte para o Nó 18 foi adicionado para [pipelines de front-end e pilha completa](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines).
  ...
  * O Maven foi atualizado para a versão 3.8.8
    ...
    * A [Adobe recomenda](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details) a atualização dos repositórios Maven para o uso de HTTPS em vez de HTTP.
...
>[!NOTE]
>
>O suporte estendido do AEM 6.4 será encerrado. Para obter mais detalhes, consulte os [períodos de suporte técnico](https://helpx.adobe.com/br/support/programs/eol-matrix.html) da Adobe. Localize as [versões com suporte aqui](https://experienceleague.adobe.com/en/docs?lang=pt-BR).
