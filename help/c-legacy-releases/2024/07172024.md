...
| Junho de 2024 | Falha na [[!DNL Copy Content Activity]  com o erro *[!DNL javax.jcr.AccessDeniedException]*](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-24424) | Novo artigo | Saiba por que o processo de refluxo de conteúdo falha com o erro *[!DNL javax.jcr.AccessDeniedException]* durante o registro de namespace no [!DNL Adobe Experience Manager]. |
...
| Junho de 2024 | [Migração do processo de entrada de suporte do Adobe Commerce para a  [!DNL Experience League]](https://experienceleague.adobe.com/pt-br/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/adobe-commerce-support-intake-process-migration) | Novos artigos | Estamos animados em anunciar que, em nossa jornada de estarmos melhor conectados à família de soluções da Adobe, a Adobe Commerce está migrando nosso processo de entrada de suporte da Central de Ajuda da Adobe Commerce para o Adobe [!DNL Experience League] em 15 de julho de 2024. [!DNL Experience League] No momento, o é a página inicial da documentação de autoajuda, guias do usuário e práticas recomendadas do Adobe Commerce. Ela se tornará o principal recurso para todas as necessidades de suporte, desde o autoatendimento até a comunicação orientada por agente. Agradecemos sua compreensão e apoio à medida que fazemos essa importante transição. |
