...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|February 2024|[Project link (URL) generated changes when you share an Adobe Analytics workspace](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html?lang=pt-BR)|New article| This article offers a solution to the Adobe Analytics issue where a project link changes each time a workspace project link is retrieved in a shared Adobe Analytics workspace. You can use either the newly generated link or the previously generated link for access to the target project.|
...
Watch the [November 2023 Release Overview video](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/2023/2023-11-0.html?lang=pt-BR) for a summary of the features added in the 2023.11.0 (November 2023) release. 
-->
...
* [Notas de versão do Experience Manager 6.4 Cumulative Fix Pack](https://experienceleague.adobe.com/pt-br/docs/experience-manager-64/release-notes/cfp-release-notes?lang=pt-BR)
...
* [Guias do Experience Manager as a Cloud Service](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/overview/introduction?lang=pt-BR)
...
* [Página inicial de aprendizagem e suporte do Experience Manager 6.5](https://experienceleague.adobe.com/pt-br/docs/experience-manager-65/content/implementing/deploying/introduction/platform?lang=pt-BR)
* [Página inicial de aprendizagem e suporte do Experience Manager 6.4](https://experienceleague.adobe.com/pt-br/docs/experience-manager-64?lang=pt-BR)
...
* [!DNL Campaign Web Interface]: [Novidades](https://experienceleague.adobe.com/pt-br/docs/campaign-web/v8/whats-new?lang=pt-BR) | [Documentação do produto](https://experienceleague.adobe.com/pt-br/docs/campaign-web/v8/campaign-web-home)
...
|abril de 2024|[[!DNL Workfront] eventos recentes](https://experienceleague.adobe.com/pt-br/docs/events/workfront-recordings/overview?lang=pt-BR)|Vários vídeos |Exibir todos os [!DNL Workfront] eventos recentes no Experience League.|
