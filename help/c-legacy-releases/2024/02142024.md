---
title: Notas de versão centrais — Fevereiro de 2024
...
* [Notas de versão do [!DNL Experience Platform]](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=pt-BR)

* [Notas de versão do [!DNL Experience Platform] Mobile SDK](https://developer.adobe.com/client-sdks/documentation/release-notes/)

### Novos tutoriais e cursos do [!DNL Experience Platform]{#tutorials-aep}

Novos vídeos, tutoriais ou cursos publicados para o Adobe [!DNL Experience Platform].
...
Assista ao [vídeo Visão geral da versão de janeiro de 2024](https://video.tv.adobe.com/v/3448934?captions=por_br&quality=12") para obter um resumo dos recursos adicionados na versão 2024.01.0 (janeiro de 2024).
...
O Extension Manager no AEM Sites permite que desenvolvedores e profissionais acessem, gerenciem e personalizem [Extensões da interface](https://developer.adobe.com/uix/docs/) criadas com o [App Builder Adobe](https://developer.adobe.com/app-builder/) para aprimorar a funcionalidade do AEM Sites.
...
* A habilitação de assinaturas de evento na configuração do EWC resulta em falhas repetidas de chamada de API com o erro `HTTP 400` ao configurar o conector avançado do Workfront pela primeira vez.
...
* **Blogs recentes de usuários da comunidade do AEM**
   ...
   * [Explorando o poder oculto do AEM: desbloqueando as maravilhas do OSGi](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/exploring-aem-s-hidden-power-unlocking-osgi-marvels/ba-p/648162?profile.language=pt)
   * [AEM 6.5.5 Sem problema de indexação *Corrigido*](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-6-5-5-not-indexing-problem-fixed/ba-p/639836?profile.language=pt)
...
* [Notas de versão do Experience Manager 6.4 Cumulative Fix Pack](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/cfp-release-notes.html?lang=pt-BR)
...
* [Notas de versão do aplicativo de desktop do Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html?lang=pt-BR)
...
* [Guias do Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/overview/introduction.html?lang=pt-BR)
...
* [Página inicial de aprendizagem e suporte do Experience Manager 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/deploying/introduction/platform.html?lang=pt-BR)
* [Página inicial de aprendizagem e suporte do Experience Manager 6.4](https://experienceleague.adobe.com/docs/experience-manager-64.html?lang=pt-BR)
...
Learn more about [[!DNL Experience Manager Guides]](https://business.adobe.com/br/products/experience-manager/guides/features.html).
...
| Janeiro de 2024 | [O fuso horário não está correto no esquema do  [!DNL Google BigQuery] )](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23329.html?lang=pt-BR) | Novo artigo | Conheça a solução do problema, no [!DNL Adobe Campaign Classic v8.5], se ao ler dados da coluna de uma tabela do [!DNL Google BigQuery] definida como `datetimetz` no nível do esquema, a data e a hora exibidas não incluírem as informações de fuso horário do operador. |
...
|---------|----|----|-----------|
|December 2023|[Inaccurate click volume in [!DNL AJO] email tracking data](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23027.html?lang=pt-BR)|New article| Learn about one of the possible causes for discrepancies in email-tracking data.|
|December 2023|[Segment didn't evaluate a profile, but [!DNL Journey] still sent an email](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22975.html?lang=pt-BR)|New article| Learn about if [!DNL Journey] sends out emails even when [!DNL Segment] has not evaluated any profiles.|
|December 2023|[[!DNL AJO] - `now()` timestamp adding extra digits to the milliseconds](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22978.html?lang=pt-BR)|New article| Learn how to resolve the issue with importing files when the `now()` timestamp adds extra digits to the milliseconds.|
...
* [Tutoriais da API de serviços da Adobe Acrobat](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/overview.html?lang=pt-BR)
