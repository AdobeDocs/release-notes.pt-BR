---
title: Notas de versão centrais - outubro de 2021
...
| Navegação do Experience Cloud [!UICONTROL Triggers] | O [Experience Cloud Triggers](https://experienceleague.adobe.com/docs/core-services/interface/triggers.html) está disponível para navegação direta a partir do alternador do aplicativo no cabeçalho para usuários provisionados. |
...
| [Credenciais que não expiram](https://experienceleague.adobe.com/docs/experience-platform/query/ui/credentials.html?lang=pt-BR) | As Credenciais que não expiram para usuários do [!UICONTROL Serviço de consultas] permitem conexões mais permanentes a clientes externos, em vez de renovar credenciais a cada 24 horas. |
