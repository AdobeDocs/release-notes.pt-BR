---
title: Notas de versão centrais — Maio de 2021
...
| Maio de 2021 | [Personalizar configurações do calendário no Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/customize-calendar-settings.html#administration) | Vídeo | Aprenda algumas dicas e truques, bem como os mecanismos de personalização de seu calendário no Adobe Analytics. |
...
* Adição do [código de erro do sistema DCS 10](https://experienceleague.adobe.com/docs/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-error-codes.html#system-error-codes), indicando se os traços na solicitação foram parcialmente avaliados ou se não foram avaliados.
...
* **Adobe Experience Manager as a Cloud Service**
  ...
  * **Experience Manager Assets as a Cloud Service**
    ...
    * Os administradores podem configurar o Experience Manager para excluir a origem de ativos depois de fazer uma ingestão de ativos em massa. Consulte [ingestão de ativos em massa](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
    * Ao executar uma verificação de integridade para importar ativos em massa, o Experience Manager agora fornece mais motivos de informações sobre falhas. Consulte [ingestão de ativos em massa](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
    * Ao importar ativos usando a ferramenta de importação em massa, os administradores agora podem, opcionalmente, excluir os arquivos de origem após a importação ser bem-sucedida. Consulte [ingestão de ativos em massa](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
  ...
  * **Experience Manager Forms as a Cloud Service**
    ...
    * **Usar o método de verificação de ID do governo nos Formulários adaptáveis do Adobe Sign**
      ...
      Alimentado por algoritmos avançados de aprendizado de máquina, o processo de verificação por documento de identidade do Adobe Sign oferece a empresas do mundo todo a capacidade de garantir uma validação de alta qualidade da identidade dos seus destinatários. Agora, você pode usar o método de verificação de ID do governo nos formulários adaptáveis habilitados no Adobe Sign.

      ID do governo é um método de verificação de identidade premium. Ele instrui o destinatário a [fazer o upload de uma imagem de um documento de identidade emitido pelo governo (CNH, carteira de identidade, passaporte)](https://helpx.adobe.com/br/sign/using/adobesign-authentication-government-id.html). Em seguida, avalia esse documento para assegurar sua autenticidade.
  ...
  * **Experience Manager Commerce as a Cloud Service**
    ...
    * Indicador visual para dados de catálogo preparados na vitrine do Experience Manager.
  ...
  * **Cloud Manager**
    ...
    * A guia Soluções em Adicionar programa e Editar fluxos de trabalho do programa exibe a solução, mesmo se apenas uma solução estiver disponível para o programa.
...
* **[Anúncio de um novo processo para enviar solicitações de recursos do Experience Manager](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/announcing-the-new-process-to-submit-experience-manager-feature/td-p/380425?profile.language=pt)**
...
| Recurso | Descrição |
| -----------| ---------- |
| Configurações de pacote | Uma nova opção [!UICONTROL Estratégia de preenchimento de pacote], &quot;[!UICONTROL Ligeiramente à frente]&quot;, está disponível e é o padrão para novos pacotes. Essa estratégia acelera a entrega, de modo que esteja 55 a 65% concluída por volta da metade do processo. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Maio de 2021 | [Controle sua experiência online com PDF e colete análises](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=pt-BR#part1) | Artigo | Saiba como usar a API incorporada do Adobe PDF para controlar a aparência, habilitar a colaboração e coletar análises sobre como os usuários interagem com PDFs, incluindo o tempo gasto em uma página e pesquisas. (Quatro partes). |
