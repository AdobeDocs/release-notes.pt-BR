---
title: Notas de versão centrais — Junho de 2021
...
Os componentes da interface central do Experience Cloud incluem atualizações a serem acessadas do cabeçalho unificado do produto, como autoajuda, pesquisa e preferências da conta de usuário. As atualizações para Pessoas, Places (Localização) e gerenciamento de produtos são encontradas aqui.
...
As atualizações mais recentes do Status de sistema da Adobe são encontradas em [Status de sistema da Adobe - 21 de maio de 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html) para obter as informações de lançamento mais recentes.
...
| Junho de 2021 | [Blocos de construção de esquema](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/schema-building-blocks.html?lang=pt-BR) | Vídeo | Saiba mais sobre os elementos principais dos blocos de construção de esquemas do Experience Data Model (XDM), incluindo campos, tipos de dados, grupos de campos de esquemas, classes e comportamento. |
| Junho de 2021 | [Criar classes de esquema](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-classes.html?lang=pt-BR) | Vídeo | Saiba como criar classes no Adobe Experience Platform para usar em esquemas do Experience Data Model (XDM). |
...
| Junho de 2021 | [Criar tipos de dados de esquema](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-data-types.html?lang=pt-BR) | Vídeo | Saiba como criar seus próprios tipos de dados no Adobe Experience Platform para usar em esquemas do Experience Data Model (XDM). |
| Junho de 2021 | [Converter seu modelo de dados em um Experience Data Model](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/convert-your-data-model-to-xdm.html?lang=pt-BR) | Vídeo | Saiba como os arquitetos de dados podem converter seu modelo de dados transacionais existente em um Experience Data Model. Este vídeo mostra a diferença nas abordagens de modelagem usando diagramas de relação de entidade. |
| Junho de 2021 | [Planejar seu modelo de dados](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/plan-your-data-model.html?lang=pt-BR) | Vídeo | Saiba o que fazer antes de começar a criar seus esquemas no Adobe Experience Platform. Documente os casos de uso do seu negócio, entenda sua licença do Platform, conheça as medidas de proteção do produto e identifique quais dados devem ser assimilados antes de finalizar seu modelo de dados. |
| Junho de 2021 | [Conectar o Tableau ao Serviço de consultas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/psql-client-tableau.html?lang=pt-BR) | Vídeo | Saiba como se conectar ao [!UICONTROL Serviço de consultas] de vários aplicativos de cliente de desktop que oferecem suporte ao protocolo `PostgreSQL` e como usar ferramentas e drivers `PostgreSQL` para conectar e gravar consultas. |
| Junho de 2021 | [Funções definidas pela Adobe no Serviço de consultas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/adobe-defined-functions.html?lang=pt-BR) | Vídeo | Saiba como usar funções definidas pela Adobe no [!UICONTROL Serviço de consultas] da Adobe Experience Platform para executar tarefas comerciais comuns em dados de evento de experiência. |
| Junho de 2021 | [Exploração de dados com o Serviço de consultas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/explore-data.html?lang=pt-BR) | Vídeo | Saiba como validar dados assimilados, pré-visualizar dados e explorar as propriedades estatísticas e analíticas de dados usando funções SQL. |
| Junho de 2021 | [Visão geral do Serviço de consultas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/understanding-query-service.html?lang=pt-BR) | Vídeo | Saiba mais sobre o Serviço de consultas na Adobe Experience Platform e como ele ajuda a entender o comportamento do cliente e gerar insights de impacto. |
| Junho de 2021 | [Visão geral da interface de usuário do Serviço de consultas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/query-service-ui.html?lang=pt-BR) | Vídeo | Saiba como gravar e executar consultas, exibir consultas executadas anteriormente e acessar consultas salvas por outros usuários em sua Organização IMS no Serviço de consultas da Adobe Experience Platform. |
| Junho de 2021 | [Consultar API](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/query-service-api.html?lang=pt-BR) | Vídeo | Saiba como gravar e executar consultas, criar consultas de agendamento e criar um modelo de consulta usando a [!UICONTROL API do Serviço de consultas] da Adobe Experience Platform. |
...
* Foi lançado um aprimoramento ao [Relatório de uso de atividade](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/activity-usage-reporting.html) que agora permite examinar dados criados há mais de um ano. (AAM-58268)
* O Adobe fornece aos clientes do Audience Manager chaves de acesso do usuário para os buckets do Audience Manager Amazon S3. Por motivos de segurança, as chaves agora são automaticamente desabilitadas após 100 dias de inatividade. Para obter mais informações, consulte a pergunta na parte inferior da página em [Perguntas frequentes sobre coleta de dados e integração de produto](https://experienceleague.adobe.com/docs/audience-manager/user-guide/faqs/faq-data-collection.html).

## Experience Manager {#aem}

Novos recursos, correções e atualizações no Experience Manager (AEM). A Adobe recomenda que clientes com implantações locais implantem as correções mais recentes para assegurar maior estabilidade, segurança e desempenho.
...
* **Experience Manager6.5.9.0**
  ...
  O Experience Manager 6.5, Service Pack 9.0 (6.5.9.0 lançado em 27 de maio de 2021) é uma atualização importante que inclui novos recursos, principais melhorias solicitadas por clientes, melhor desempenho, estabilidade e segurança, lançado desde a disponibilização geral do AEM 6.5, em abril de 2019.
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Junho de 2021 | [Consultas Persistentes GraphQL](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/graphql-persisted-queries.html) | Vídeo | Saiba como habilitar, criar, atualizar e executar consultas persistentes no Experience Manager. |
| Junho de 2021 | [Criar seu primeiro servlet no AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/create-servlet.html) | Artigo | Crie seu primeiro servlet sling para mesclar dados com um modelo de formulário. |
| Junho de 2021 | [Criar seu primeiro serviço OSGi com formulários do Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/create-osgi-service.html) | Artigo | Crie seu primeiro serviço OSGi com o AEM Forms para poder gerar PDFs mesclando dados e modelos. |
...
* **Adobe Campaign Classic v7 versão 21.1.3**: para saber mais, consulte as [Notas de versão do Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=pt-BR).
...
| Junho de 2021 | [Criar e projetar entregas de email](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/content-creation/email/create-and-design-email-deliveries.html?lang=pt-BR) | Campaign V8 | (Vídeo) Entenda o processo de criação de uma entrega de email e saiba como projetar e personalizar o conteúdo de email. |
| Junho de 2021 | [Projetar emails para entrega](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/email/design-emails-for-deliverability.html?lang=pt-BR) | Campaign V8 | (Vídeo) Saiba como aplicar as práticas recomendadas de capacidade de entrega em seus emails. |
| Junho de 2021 | [Gerenciar fadiga usando regras de tipologia](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/fatigue-management/typology-rules-for-fatigue-management.html?lang=pt-BR) | Campaign V8 | (Vídeo) Saiba como implementar o gerenciamento de fadiga aplicando regras de tipologia. |
...
| Recurso | Descrição |
| ------- | ----------- |
| [!UICONTROL Campanhas] | (Campanhas do Google Ads) A [!UICONTROL Advertising Cloud Search] agora sincroniza, otimiza e fornece atribuição para anúncios de inventário locais em campanhas de compras.<br><br>Configure e gerencie seus anúncios de inventário locais no Google Ads. |
|  | Ao editar várias campanhas e componentes de campanha, você não pode mais salvar suas alterações como um rascunho para revisão na visualização Pendente, nem agendar as alterações para um horário específico. Todos os processos agendados já existentes ainda serão executados conforme agendado. |
| [!UICONTROL Insights de publicidade] | Os seguintes insights estão disponíveis no modo beta:<ul><li>[!UICONTROL Sim normalizado (combinado) beta]</li><li>[!UICONTROL Lançamento de portfólio beta]</li> |
| [!UICONTROL Centro de notificações beta] | Agora você pode receber e gerenciar notificações fora do seu navegador instalando o aplicativo [!UICONTROL Central de notificações beta] para o Google Chrome 40 e Microsoft Edge 17 ou versões posteriores. O aplicativo carrega mais rápido do que a versão tradicional de navegador e atualiza automaticamente.<br><br>Depois de instalar o aplicativo, o aplicativo web será carregado como uma janela separada que reorganiza dinamicamente o layout com base no tamanho da janela. Você não precisa fazer logon no aplicativo ou ter uma janela do navegador aberta para usá-lo. |
|  | Um novo tipo de alerta, [!UICONTROL Ações da interface do gerenciamento de campanhas], está disponível e mostra o status final de todas os processos em segundo plano, incluindo edições e alterações de atribuição em massa realizadas nos portfólios, restrições, classificações e eventos. Você será inscrito automaticamente nos alertas das ações de interface.<br><br>Em determinado momento, esse tipo de alerta substituirá as antigas notificações de status de processos disponíveis na barra de ferramentas à direita. |
| Relatórios | O novo [!UICONTROL Relatório de campanha por hora] mostra dados de custo, cliques e, opcionalmente, dados de conversão de uma ou mais campanhas do Google com palavras-chave para cada hora do intervalo de datas especificado. Este relatório é idêntico ao [!UICONTROL Relatório de campanha] com um sistema de agregação de dados por “hora” ou “dia da semana (por hora)”. Esses tipos de agregação serão removidos do [!UICONTROL Relatório de campanha] em uma versão futura. |
