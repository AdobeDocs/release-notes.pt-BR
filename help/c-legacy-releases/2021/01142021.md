...
| 29 de outubro de 2020 (atualizado) | [Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/demo-of-offer-decisioning.html?lang=pt-BR) | Vídeo | Descubra como as marcas podem usar o novo serviço de [!UICONTROL Offer Decisioning] da Adobe para definir e gerenciar suas ofertas, aproveitar os dados de clientes em tempo real e fornecer as experiências certas que os clientes esperam. |
...
<!-- [Incident Response Bulletin](https://helpx.adobe.com/br/security/products/campaign/apsb21-04.html) (January 12) -->
...
| Publicado | Nome | Solução | Descrição |
| ----------- | ----------- | ---------- | ---------- |
| 21 de novembro de 2025 | [Criar Painéis da Advertising com o Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html?lang=pt-BR) | Vídeo | Técnicas para criar um painel da Advertising para monitoramento de campanha ao vivo. |
