---
title: Notas de versão centrais — Abril de 2021
...
* [Notas de versão do Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=pt-BR) (Lançamento: 18 de fevereiro de 2021)
...
| Abril de 2021 | [Como configurar um destino do Social](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-a-social-destination.html#destinations) | Vídeo | Neste vídeo, analise a configuração de um destino do Social na Platform, incluindo autenticação, atribuição de segmento, mapeamento de ID e assim por diante. |
...
* Correção de um problema em [Relatórios gerais](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/general-reports.html#reporting), em que um usuário selecionava uma data no controle **[!UICONTROL Para datas até]**, mas os dados do relatório eram deslocados em um dia. (AAM-57702)
* Correção de um problema em [Administração > Grupos](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/administration-overview.html#create-group), em que os usuários recebiam o erro _O seu grupo foi salvo com êxito, mas ocorreu um erro ao salvar o erro de permissões de grupo_ ao salvar permissões de grupo devido a tempos-limite. (AAM-57406, AAM-57411)
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Abril de 2021 | [Compreensão da Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/?recommended=AudienceManager-U-1-2020.1.rtcdp&lang=pt-BR) | Curso | Os clientes do Audience Manager estão reimaginando o gerenciamento de conteúdo migrando para a Plataforma de dados do cliente em tempo real (CDP em tempo real) da Adobe. Este curso adota uma abordagem conceito a conceito, ajudando os usuários do Audience Manager a entender como esses conceitos são tratados na Real-time CDP. |
| Abril de 2021 | [Compreensão de destinos na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-destinations-for-aam-users.html) | Vídeo | À medida que você migra do Audience Manager para a [!UICONTROL Real-time Customer Data Platform] (Real-time CDP), é fundamental conhecer os destinos para que você saiba como ativar os segmentos de público para parceiros de destino. Este vídeo discute os diferentes tipos de destino e onde eles estão na Real-time CDP. |
| Abril de 2021 | [Compreensão da governança de dados na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-data-gov-for-aam-users.html#other-integrations) | Vídeo | Este vídeo orienta os usuários do Audience Manager sobre a funcionalidade de governança de dados na [!UICONTROL Real-time Customer Data Platform], comparando-a com a que estava disponível no Audience Manager. Ele discute a estrutura [!UICONTROL Uso de dados e aplicação de rotulagem] (DULE) e onde é possível aplicá-la na Platform. |
| Abril de 2021 | [Os dois lados da moeda - marcas e consumidores - evento](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/brands-vs-consumers.html#industry) | Artigo | Hoje, os profissionais de marketing estão sobrecarregados com o excesso de informações dedicadas às práticas de identidade. E apenas 37% dos profissionais de marketing disseram estar preparados para um futuro sem cookies, de acordo com pesquisas recentes da Adobe e da Advanis. Neste webinário, a Adobe revela o nível de compreensão e disponibilidade de anunciantes e editores para um futuro sem cookies, o impacto em seus casos de uso e a percepção que eles têm do ecossistema mais amplo. |
| Abril de 2021 | [Dez considerações para o gerenciamento responsável de dados do cliente - evento](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/ten-considerations-for-responsible-customer-data-management.html#industry) | Artigo | As forças de mercado voláteis e os diferentes requisitos de privacidade do consumidor podem apresentar cenários intimidantes para o profissional de marketing digital. Para manter as campanhas em conformidade com os regulamentos, as equipes de marketing precisam de seus parceiros de TI para terem um processo simplificado a fim de desenvolver um processo de governança de dados. Esse processo deve capacitar todos a seguir e aplicar regras de uso responsável dos dados do consumidor. Ouça o que a Adobe e o [!DNL Scotiabank] [!DNL Digital] têm a dizer sobre as principais considerações para um gerenciamento responsável de dados. |
| Abril de 2021 | [O futuro do gerenciamento de dados e do ambiente em mudança - evento](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/the-future-of-data-management-and-the-changing-environment.html#industry) | Artigo | À medida que as forças de mercado trazem mudanças ao nosso cenário digital, os negócios devem se adaptar a uma nova realidade em relação à governança de dados, à resolução de identidade e em como envolver clientes potenciais e visitantes com pseudônimos com conteúdo significativo. |
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Os administradores do Experience Manager podem agendar ingestões de ativos em massa em uma data ou hora específica. Além disso, os administradores podem agendar ingestões recorrentes de acordo com a data e a hora. Consulte o vídeo [Ferramenta de assimilação em massa de ativos](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * Lançamento do site de referência CIF Venia em 25/03/2021 que inclui a versão mais recente dos componentes principais do CIF 1.9.0. Consulte [Site de referência do CIF Venia - 25/03/2021](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.03.25) para obter mais detalhes.
      * Lançamento de componentes principais do CIF 1.9.0. Consulte [Componentes principais do CIF 1.9.0](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.9.0) para obter mais detalhes.

   * **Cloud Manager**

      * A interface do usuário atualiza os fluxos de trabalho Adicionar e Editar programa para torná-los mais intuitivos.
...
| Abril de 2021 | [Criação de consultas GraphQL](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/creating-graphql-queries.html?lang=pt-BR) | Vídeo | Saiba como criar consultas GraphQL para recuperar conteúdos do Adobe Experience Manager (AEM) e como usar a ferramenta GraphiQL para testar, refinar e depurar consultas rapidamente. |
...
| -----------| ---------- | ---------- | ---------- |
| 12 de abril de 2021 | [Rastrear o sucesso das entregas no Analytics](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/integrations/track-the-success-of-your-deliveries-in-analytics.html#integrations) | Campaign Standard | Saiba como configurar a integração do Campaign Standard e do Analytics. Entenda como criar um relatório no Analytics usando dados recebidos do Campaign Standard e quais KPIs estão disponíveis. |
...
| Inventário privado | (Versão de 15 de outubro) Todos os usuários agora podem configurar e editar informações da ID de negócios usando um novo formulário, que é uma versão simplificada do formulário antigo de Veiculação de anúncios inteligentes. Para configurar os detalhes de novas IDs de transações, acesse **[!UICONTROL Inventário]** > **[!UICONTROL Transações]** > **[!UICONTROL Criar]** e depois clique em **[!UICONTROL ID de transação Beta]**. |
...
| Publicado | Nome | Solução | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Abril de 2021 | [Gerenciamento de fluxos de trabalho de documentos financeiros com APIs do Adobe Document Services em Java™](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/FinanceWorkflowsJava.html?lang=pt-BR) | Tutorial | Saiba como você pode usar APIs de serviços de documentos da Adobe para[!DNL Java™ Spring Boot] aplicativos e construir um aplicativo model-view-controller (MVC) que extrai conteúdo de documentos PDF, converte-o em outros formatos de dados, como Excel, combina vários PDFs e protege os recursos com senha. |
| Abril de 2021 | [Controle sua experiência online com PDF e colete análises](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=pt-BR) | Artigo | Sua organização publica PDFs no seu site? Saiba como usar a API incorporada do Adobe PDF para controlar a aparência, habilitar a colaboração e coletar análises sobre como os usuários interagem com PDFs, incluindo o tempo gasto em uma página e pesquisas. |
| Abril de 2021 | [Gerenciamento de fluxos de trabalho de documentos financeiros com APIs do Adobe Document Services em Java™](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/FinanceWorkflowsJava.html?lang=pt-BR) | Artigo | Saiba como você pode usar APIs de serviços de documento da Adobe para aplicativos Java™ Spring Boot. Crie um aplicativo model-view-controller (MVC) que extrai conteúdo de documentos do PDF, converte-o em outros formatos de dados, como Excel, combina vários PDFs e protege os recursos com senha. |
| Abril de 2021 | [Fluxos de trabalho de documentos de RH com APIs do Adobe Document Services em Java™](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/HRAgreementWorkflowsJava.html?lang=pt-BR) | Tutorial | Muitos negócios exigem documentação sobre uma nova contratação, como contratos de trabalho para funcionários que trabalham de casa. Por tradição, os negócios gerenciavam esses documentos fisicamente, em formas difíceis de gerenciar e armazenar. Ao mudar para documentos eletrônicos, os arquivos PDF são a escolha ideal, pois são mais seguros e menos modificáveis do que outros tipos de arquivos. Além disso, também oferecem suporte para assinaturas digitais. |
| Abril de 2021 | [Fluxos de trabalho de contrato com APIs do Adobe Document Services em Node.js](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/AgreementWorkflowsNodejs.html?lang=pt-BR) | Tutorial | Muitos aplicativos e processos de negócios exigem documentação como propostas e contratos. Os documentos PDF garantem que os arquivos sejam mais seguros e menos modificáveis. Eles também fornecem suporte a assinatura digital para que seus clientes possam preencher os documentos de forma rápida e fácil. As APIs do Adobe Document Services incorporam facilmente os recursos PDF ao seu aplicativo web. |
