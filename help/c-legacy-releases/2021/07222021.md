...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
     ...
     Visite [Experience Manager Guides](https://business.adobe.com/br/products/experience-manager/guides/aem-guides.html) para obter mais informações.
...
| -----------| ---------- | ---------- | ---------- |
| Julho de 2021 | [Refinar públicos-alvo combinando resultados de query](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/targeting-workflows/refine-targets-by-combining-query-results.html?lang=pt-BR) | Campaign v8 | Saiba como refinar seu público-alvo combinando os resultados da consulta em um fluxo de trabalho usando a interseção ou as atividades de união. |
