...
| 21 de março de 2021 | [Noções básicas sobre esquemas e XDM na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-schemas-xdm-for-aam-users.html?lang=pt-BR#other-integrations) | Vídeo | Ao migrar do Audience Manager para a Real-time Customer Data Platform (Real-time CDP), você encontrará alguns novos conceitos e práticas. Os esquemas e o XDM se encaixam nessa categoria. Este vídeo explica esses conceitos. |
...
| 3 de março de 2021 | [Noções básicas de traços na Real-time Customer Data Platform para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.html?lang=pt-BR#other-integrations) | Vídeo | Conheça os traços no Audience Manager e o equivalente na Real-time Customer Data Platform. |
| 3 de março de 2021 | [Noções básicas da ingestão de dados primários na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-1pd-ingestion-for-aam-users.html?lang=pt-BR#other-integrations) | Vídeo | Saiba mais sobre a ingestão de dados offline primários na Real-time Customer Data Platform (Real-time CDP). Conheça algumas das principais diferenças entre os dois produtos em relação à ingestão de dados e como o Conector de dados do Audience Manager pode ser usado como uma solução temporária até que os processos tenham sido transferidos para a Real-time CDP. |
| 1 de março de 2021 | [Comercializar seus próprios públicos-alvo oferecendo no Audience Marketplace](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/audience-marketplace/selling-data/commercialize-owned-audiences-on-marketplace.html?lang=pt-BR#audience-marketplace) | Vídeo | Saiba como configurar seus dados como um feed de dados privado ou público-alvo no Audience Marketplace, tornando-o um provedor de dados de terceiros. |
...
* **Adobe Summit 2021 | Lista completa de sessões do Experience Manager**
  ...
  [Aqui](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344?profile.language=pt) está uma lista agregada de todas as sessões do Experience Manager que ocorrerão no **Adobe Summit 2021**.
...
| Março de 2021 | [Foundation - Gerenciamento de fluxo de trabalho](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/administering/workflows-administering.html?lang=pt-BR) | Vídeo | Este vídeo usa Modelos de fluxo de trabalho para demonstrar esse conjunto de recursos. No entanto, eles também se aplicam a Iniciadores do AEM. |
