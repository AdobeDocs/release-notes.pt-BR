...
| ----------| ---------- | ---------- |---------- |
| 2025 de setembro | [Tutorial de composição de público-alvo federado](https://experienceleague.adobe.com/pt-br/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview) | Vídeo | Interaja com públicos diretamente do data warehouse usando a Federated Audience Composition (FAC). |
