...
* [[!DNL Adobe Experience Cloud] - Interface e administração centrais](#ecloud)
...
* **[!DNL ANALYTICS]** | Webinário | _Descubra e forneça insights acionáveis com o Adobe Analytics_ | **5 de outubro às 9h BST** | [Registrar](https://adobeanalyticsemea2023.experienceleague.adobeevents.com/)

* **[!DNL WORKFRONT]** | Webinário | _Novidades do Adobe Workfront 23.10?_ | **5 de outubro às 10h00 ET** | [Registrar](https://event.on24.com/wcc/r/4338212/18470D85C5958448AE20FC2AF0DA9977?partnerref=EXL)

* **[!DNL EXPERIENCE MANAGER]** | Webinário | _Expressos e Experience Manager: atualização para o Dynamic Media_ | **5 de outubro às 23h MDT** | [Registrar](https://register.gotowebinar.com/register/401473910088026710?source%3CExL)

* **[!DNL WORKFRONT]** | Workshop do cliente | _Pergunte aos especialistas: automatize seus processos de trabalho com o Workfront Fusion_ | **5 de outubro às 11h (MT)** | [Registrar](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,aYVhAxfDTEaHWan3DDKAJg,hP4GoDgz30K_R39XZWjjfQ,6wmf7dtjHkG6osxVzGe7nQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
* **[!DNL AEM]** e **[!DNL COMMERCE]** | Desenvolvedores em tempo real | _Conteúdo e comércio: uma sessão aprofundada sobre [!UICONTROL Edge Delivery Services], recursos headless, extensibilidade, capacidade de composição e ferramentas de produtividade_ | **6 de novembro às 8h (MT)** | [Registrar](https://developerevents.adobe.com/events/details/adobe-developer-events-developer-experience-presents-adobe-developers-live-content-and-commerce/?code=release)
...
* [!DNL Adobe Status] adicionou um **[!UICONTROL Ajuda]** para fornecer um tour guiado da Visão geral/Página inicial e da funcionalidade disponível para os clientes.

* Desenvolvedores e administradores também podem verificar a seção Ajuda para obter mais informações sobre APIs de status.

| Recurso | Descrição |
| ------- | ------- |
| Menu Ajuda | <ul><li>As visitas guiadas fornecem ajuda no contexto sobre as várias seções e componentes da página Visão geral. Ela também destaca as ações que os usuários podem realizar, como assinar notificações proativas.</li><li>O Guia do desenvolvedor aponta para a [!DNL Status] Documentação da API no portal do Adobe Developer. Ele pode ajudar os desenvolvedores a entender as etapas de integração [!DNL Status] APIs e as informações disponíveis a elas com seus painéis internos.</li></ul> |
| Melhorias | <ul><li>[!DNL Status] A documentação da API foi atualizada com Oath 2.0, o método preferido de autenticação da API, já que o token JWT está obsoleto.</li><li>Eventos, incidentes e APIs de manutenção agora retornam mensagens em inglês por padrão e, além disso, aceitam parâmetros de localidade para mensagens localizadas.<ul><li>Nenhuma API adicional precisa ser chamada para obter eventos, e suas mensagens - os tokens de mensagem e o suporte local agora estão integrados nessas APIs.</li></ul></li></ul> |
| Correções de erros | <ul><li>O banner da página na nuvem agora exibe a contagem de manutenção correta<ul><li>[!DNL Status] o banner exibido vazio quando havia apenas manutenções programadas</li><li>O banner não mostrava manutenção contínua</li></ul><li>Email fechado enviado corretamente quando um incidente é fechado e, ao mesmo tempo, a prioridade é atualizada de Grave para Menor OU Menor para Grave.</li><li>[!DNL Status] APIs - eventos duplicados removidos</li><li>Os dados de assinatura obsoletos foram limpos e o serviço de assinatura foi corrigido para garantir que todos os assinantes recebessem os emails necessários. Essa correção melhorou a confiabilidade e o desempenho do nosso serviço de email.</li></ul> |
...
## ![Ícone](/assets/ec_appicon_24.png) [!DNL Experience Cloud] - Interface e administração centrais {#ecloud}

Saiba mais sobre [!DNL Experience Cloud] componentes e administração da interface central. Gerencie produtos e usuários, defina configurações e preferências de perfil, pesquise por objetos da Experience Cloud e gerencie cookies.
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Setembro de 2023 | Destinos | [Visão geral dos destinos](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/understanding-destinations.html) | Vídeo | Saiba mais sobre os tipos de destino que você pode usar para obter dados do Real-Time CDP, do Experience Platform e das tags para suportar uma grande variedade de casos de uso. |
| Setembro de 2023 | Destinos | [Configurar um destino de exportação do conjunto de dados no Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-dataset-export-destination.html) | Vídeo | Saiba mais sobre a configuração, o fluxo de trabalho e os casos de uso para exportar conjuntos de dados do Adobe Experience Platform para um local de armazenamento na nuvem usando uma conexão de destino. |
| Setembro de 2023 | Coleção de dados | [Usar fluxos de trabalho de início rápido na Coleção de dados](https://experienceleague.adobe.com/docs/platform-learn/data-collection/event-forwarding/quick-start-workflows.html) | Vídeo | Saiba mais sobre casos de uso avançados para aproveitar ao máximo o [!DNL Facebook] ([!DNL Meta]) workflows de início rápido no [!UICONTROL Coleta de dados] |
...
### Knowledge base de suporte do [!DNL Experience Platform]{#kb-aep}

Novos artigos e atualizações de artigos já existentes do [!DNL Experience Platform].

| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Setembro de 2023 | [AEP - Compor público-alvo é somente leitura - Quais permissões são necessárias?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22841.html?lang=pt-BR) | Novo artigo | Saiba quais permissões você deve selecionar ao acessar o [!UICONTROL Públicos-alvo] seção para compor um novo público-alvo. |
| Setembro de 2023 | [[!UICONTROL Rastreamentos de destino] não aparece no Adobe Experience Platform Debugger](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22635.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução do problema em que [!UICONTROL Rastreamentos de destino] não aparece no Adobe Experience Platform Debugger. |
...
[!DNL Analytics] data de lançamento: **4 de outubro de 2023**
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Setembro de 2023 | [Não é possível enviar dados do Adobe Analytics por meio das bibliotecas principais AEP flutter](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22809.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a resolução de problemas ao enviar dados no Adobe Analytics por meio das bibliotecas principais da AEP Flutter (SDK móvel) usando a API trackAction/trackState. |
| Setembro de 2023 | [Não é possível ver o Uso de Chamadas do Servidor](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22784.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução do problema que não está visualizando o [!UICONTROL Uso de chamadas do servidor] painel. |
...
[!DNL Customer Journey Analytics] data de lançamento: **4 de outubro de 2023**
...
[Saiba mais sobre o Edge Delivery Services](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/edge-delivery/overview.html?lang=en).

### [!DNL Experience Manager Assets] as a [!DNL Cloud Service]

_Novos recursos na visualização de ativos_

* **Atribuir formulário de metadados a uma pasta** - Agora você pode atribuir o formulário de metadados a uma pasta específica na implantação. Todos os ativos na pasta, incluindo ativos nas subpastas, em seguida, exibem as propriedades definidas no formulário de metadados atribuído.

_Novos recursos na visualização de admin_

* **Integrar o AEM Assets as a Cloud Service com a criação baseada em documentos para Edge Delivery Services** - Integre o AEM Assets com a criação baseada em documentos para que o Edge Delivery Services permita que os autores de sites [usar imagens disponíveis em repositórios AEM Assets ao criar documentos no Microsoft® Word ou Google Docs](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/edge-delivery/using.html?lang=en#integrate-assets-edge).
* **Extrair arquivos ZIP** - Capacidade de selecionar arquivos ZIP que são gerenciados no Experience Manager e [extração de arquivos diretamente no Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets.html?lang=pt-BR#extract-zip-archives) sem baixá-los.

_Novos recursos no canal de pré-lançamento_

* **Dynamic Media** - [Suporte a faixas de várias legendas e áudio para vídeos no Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html?lang=pt-BR#about-msma). Agora é possível adicionar facilmente várias legendas e faixas de áudio a um vídeo principal. Com esse recurso, os vídeos estão acessíveis para um público-alvo global. Você pode personalizar um único vídeo principal publicado para um público-alvo global com vários idiomas, seguindo as diretrizes de acessibilidade de diferentes regiões. Autores(as) também podem gerenciar as legendas e faixas de áudio em uma única guia na interface.
...
* **[Adobe Analytics com automação de configuração da Experience Cloud para formulários](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/enable-adobe-analytics-adaptive-form-using-experience-cloud-setup-automation.html?lang=en)** - Agora você pode habilitar o Adobe Analytics com a automação de configuração da Experience Cloud com apenas alguns cliques. Ele permite conectar o AEM Forms as a Cloud Service com tags Experience Platform e o Adobe Analytics para capturar e rastrear métricas de desempenho para seus formulários publicados.
* **[Modelo de relatório do Adobe Analytics para o Adaptive Forms](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/view-understand-aem-forms-analytics-reports.html?lang=en)** - O Forms as a Cloud Service agora fornece um relatório do Adobe Analytics OOTB. Ele ajuda você a entender facilmente o desempenho de seus formulários. As métricas no nível do formulário fornecem um insight sobre o desempenho do formulário em vários indicadores principais de desempenho (KPIs), como representações, visitantes, envios e tempo médio de preenchimento. Ao rastrear o comportamento do usuário e o feedback, você pode identificar áreas do formulário que estão causando confusão e orientar melhorias no design e na funcionalidade do formulário.
* **[Fragmento de formulário no Forms adaptável com base nos Componentes principais](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/adaptive-form-fragments-core-components.html?lang=pt-BR)** - Diga adeus à duplicação, otimize seu inventário digital e melhore a colaboração à medida que você eleva sua experiência de criação de formulários com Fragmentos de formulário. Esses componentes reutilizáveis se integram perfeitamente a vários formulários, simplificando a criação de formulários consistentes e com aparência profissional. Os fragmentos de formulário garantem a reutilização, a padronização e a consistência da marca por meio da funcionalidade &quot;alterar uma vez e refletir em todos os lugares&quot;. Obtenha mais capacidade de manutenção e eficiência, já que as atualizações feitas em um local são propagadas automaticamente em todos os formulários que usam esses fragmentos.
* **[Etapa de fluxo de trabalho aprimorada do Adobe Sign](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=pt-BR#sign-document-step-sign-document-step)** - A etapa Fluxo de trabalho do Adobe Sign foi aprimorada para incluir:
...
* **[Forms adaptável headless](https://experienceleague.adobe.com/docs/experience-manager-headless-adaptive-forms/using/overview.html?lang=pt-BR)** : use formulários adaptáveis headless para permitir que os desenvolvedores criem, publiquem e gerenciem formulários interativos que podem ser acessados e interagidos por meio de APIs, em vez de uma interface gráfica tradicional. Os formulários adaptáveis headless ajudam a:
  ...
  Enviar um email para [aem-forms-headless@adobe.com](mailto:aem-forms-headless@adobe.com) do seu ID de e-mail oficial para participar do programa de adoção antecipada.

### [!DNL Experience Manager] as a [!DNL Cloud Service Foundation]

* **Novo comportamento do armazenamento em cache do CDN para parâmetros de URL relacionados à campanha** - Para novos ambientes, a CDN remove parâmetros de consulta relacionados ao marketing por padrão para aumentar o desempenho da campanha de marketing e as taxas de ocorrência do cache. Os ambientes existentes não são afetados. [Saiba mais](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/caching.html?lang=pt-BR#marketing-parameters).
* **Regras de filtro de tráfego (incluindo regras do WAF) do programa de adoção antecipada** - Filtrar o tráfego na CDN com base no seguinte:
...
* Se um pipeline estiver em andamento, o botão Enviar da caixa de diálogo Ativação concluída agora estará desativado e informará ao usuário que a data de ativação não pode ser definida devido à execução do pipeline.
...
A data de lançamento da versão mais recente 1.9.13 do conector aprimorado do Workfront para Experience Manager é 11 de setembro de 2023.
...
>[!IMPORTANT]
>
>A Adobe recomenda [atualizar para a versão mais recente (1.9.13)](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=pt-BR) do conector avançado do Workfront para o Experience Manager.
...
* Gravação para AEM Gems - Harness the Power of New Relic APM for AEM as a Cloud Service. Aumente o desempenho e a resolução de problemas em [https://adobe.ly/3sV67N5](https://adobe.ly/3sV67N5)
* AEM as a Cloud Service 2023.8.0 - Atualização de versão em [https://adobe.ly/3syyBwe](https://adobe.ly/3syyBwe)
* Adobe Experience Manager Community Lens 7ª edição, agosto de 2023 em [https://adobe.ly/44gK2FL](https://adobe.ly/44gK2FL)

**Sessões essenciais de expediente**

* Base para otimização de índices com o AEM Cloud Service - [https://adobe.ly/3r7vI4X](https://adobe.ly/3r7vI4X)
* Análise de falhas de implantação as a Cloud Service do AEM - [https://adobe.ly/464gXPg](https://adobe.ly/464gXPg)
* Arquitetura do AEM Forms sem periféricos - [https://adobe.ly/3sOxRD3](https://adobe.ly/3sOxRD3)

**Artigos Críticos da Base de Dados de Conhecimento**

* Como exportar referências locais de um ativo no formato JSON - [https://adobe.ly/3t83BU1](https://adobe.ly/3t83BU1)
* Carregar ativos no navegador no editor em vez de baixá-los - [https://adobe.ly/3ZohYQb](https://adobe.ly/3ZohYQb)
...
| Publicado | Aplicativos | Nome | Tipo | Descrição |
| ----------| ---------- | ---------- | ---------- |---------- |
| Outubro de 2023 | Aplicativos | [Plug-in e Edge Delivery Services do AEM Assets Sidekick](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/edge-delivery-services/sidekick-plugin.html) | Vídeo | Saiba como o plug-in Sidekick do AEM Assets pode ser usado para incorporar ativos gerenciados em experiências de alto impacto fornecidas por meio do Edge Delivery Services. |
| Setembro de 2023 | [!DNL AEM as a Cloud Service] | [[!DNL AEM as a Cloud Service] armazenamento em cache](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/caching/overview.html) | Vídeo | Saiba mais sobre armazenamento em cache no AEM as a Cloud Service. |
| Setembro de 2023 | [!DNL AEM as a Cloud Service] | [[!UICONTROL Fragmento do conteúdo] editor](https://experienceleague.adobe.com/docs/experience-manager-learn/content-fragments-console/basics/content-fragment-editor.html) | Vídeo | Uma breve introdução ao [!DNL Experience Manager] [!UICONTROL Fragmento do conteúdo] editor. |
| Setembro de 2023 | [!DNL AEM as a Cloud Service] | [Arquitetura de [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/architecture.html?lang=pt-BR) | Vídeo | Explore a arquitetura subjacente e as partes importantes do AEM as a Cloud Service com os Edge Delivery Services. |
| Setembro de 2023 | [!DNL Forms] | [Extrair documento da lista de documentos](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/custom-workflow-steps/extract-document-from-list.html) | Artigo | Saiba mais sobre componentes personalizados de fluxo de trabalho para extrair um documento específico de uma lista de documentos. |
| Setembro de 2023 | [!DNL Forms] | [Personalizar uma página de agradecimento](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/handling-af-form-submissions/thank-you-page-on-fdm-submission.html) | Artigo | Exiba a resposta do envio de um modelo de dados de formulário na página de agradecimento. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Setembro de 2023 | [A tarefa de tradução manual travava com o status &quot;Em andamento&quot;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22846.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução quando um trabalho de tradução está preso no *Em andamento* após importar o conteúdo traduzido. |
| Setembro de 2023 | [As permissões desaparecem inesperadamente no AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22839.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução para o problema em que as permissões desaparecem inesperadamente no AEM as a Cloud Service. |
| Setembro de 2023 | [Como excluir um nó restante em Publicar/Visualizar](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22828.html?lang=pt-BR) | Novo artigo | Saiba como excluir um nó restante em [Publicar/Visualizar] in [!DNL AEM as a Cloud Service]. |
| Setembro de 2023 | [Os certificados SSL são revertidos após alternar manualmente com o autor](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22814.html?lang=pt-BR) | Novo artigo | Saiba como corrigir Certificados SSL que são revertidos após alternar manualmente pelo autor. |
| Setembro de 2023 | [Não é possível carregar o console de ativos DAM no Author](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22786.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução para o problema em que, ao tentar acessar o console de ativos do AEM usando `/assets.html/content/dam`, a tela fica em branco. |
| Setembro de 2023 | [*Treinamentos inteligentes* para tags personalizadas estão falhando](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22781.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução do problema em que *Treinamentos inteligentes* para tags personalizadas estão falhando. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Setembro de 2023 | [Gerenciar Crédito da Empresa](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/company-credit.html) | Vídeo | Saiba como fazer compras em sua conta de usuários da conta da empresa B2B até o limite de crédito concedido. |
| Setembro de 2023 | [Preparo de conteúdo](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/content/content-staging.html) | Vídeo | Saiba como criar, pré-visualizar e agendar uma grande variedade de atualizações de conteúdo para sua loja diretamente do Administrador. |
| Setembro de 2023 | [Gerenciar contas da empresa](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/company-accounts.html) | Vídeo | Saiba como gerenciar as contas da empresa B2B, incluindo solicitações pendentes de aprovação. |
...
| Setembro de 2023 | [Migração de integração do método de envio UPS de SOAP para API RESTful](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/ups-shipping-method-integration-migration-from-soap-to-restful-api.html) | Novos artigos | Este artigo fornece um patch para resolver problemas com a migração de integração do método de envio do UPS (United Parcel Service) de SOAP para a API RESTful para Adobe Commerce 2.4.4 - 2.4.6-pX. |
| Setembro de 2023 | [Configuração da conexão do Adobe Commerce Intelligence para projetos existentes do Cloud Starter](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/configure-mbi-connection-for-cloud-starter-projects.html) | Novos artigos | Saiba mais sobre a solução para quando você deseja configurar a conexão do Adobe Commerce Intelligence para um projeto Cloud Starter existente. |
| Setembro de 2023 | [As vulnerabilidades encontradas por verificações de segurança de terceiros devem ir para o HackerOne](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/third-party-test-reports-are-handled-by-hackerone.html) | Novos artigos | Saiba mais sobre a solução para lidar com vulnerabilidades encontradas por verificações de segurança de terceiros. |
| Setembro de 2023 | [O login do administrador não está funcionando - o tamanho máximo da sessão permitida foi excedido](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/admin-login-not-working-allowed-session-max-size-exceed.html?lang=pt-BR) | Novos artigos | Conheça a solução para quando tentar fazer logon no painel de Administração, mas o formulário for atualizado e você não conseguir fazer logon. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|----|----|-----------|
| Setembro de 2023 | [Número máximo de SMS enviado em um dia](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22848.html?lang=pt-BR) | Novo artigo | Saiba como verificar o limite máximo de SMS que pode ser enviado em um dia. |
| Setembro de 2023 | [Alteração no campo &quot;Nome&quot; do serviço de esquema OOTB](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22857.html?lang=pt-BR) | Novo artigo | Saiba por que o *[!UICONTROL Nome]* é alterado no Schema pronto para uso (OOTB). |
| Setembro de 2023 | [O token de registro não está armazenado em _nms:appSubscriptionRcp_ tabela](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22844.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução para quando o token de registro não está sendo armazenado na `nms:appSubscriptionRcp` tabela. |
| Setembro de 2023 | [Marcas de URLs WebApps no Campaign Classic](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22750.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução da questão de um URL poder ser modificado/personalizado para ter o nome de uma empresa específica em vez de servidores Adobe, enquanto ainda está sendo hospedado por servidores Adobe. |
| Setembro de 2023 | [Erro de campo desconhecido por _Atualizar dados_ atividade](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22755.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução do problema em que um erro é lançado pelo _Atualizar dados_ atividade ao executar um workflow. |
...
| Setembro de 2023 | [Compatibilidade com aplicativos de página única (SPA) no editor da web](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/web-channel/singel-page-application-support.html) | Vídeo | Saiba como criar aplicativos de página única (SPA) no editor da web do Journey Optimizer. |
| Setembro de 2023 | [Relatórios no nível do canal](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/report-and-monitor/channel-level-reports.html) | Vídeo | Saiba como acessar, exportar e navegar por relatórios no nível do canal. |
| Setembro de 2023 | [Exportar relatórios no formato CSV](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/report-and-monitor/export-reports-in-csv-format.html) | Vídeo | Entenda como baixar um relatório no formato CSV para um único dispositivo. |
| Setembro de 2023 | [Compatibilidade com aplicativos de página única (SPA) no editor da web](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/web-channel/singel-page-application-support.html) | Vídeo | Saiba como criar aplicativos de página única (SPA) no editor da web do Journey Optimizer. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Setembro de 2023 | [Principais relatórios no Marketo Engage](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/reporting/key-reports.html) | Vídeo | Saiba mais sobre os principais relatórios no [!DNL Marketo Engage] e como extraí-los. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Setembro de 2023 | [Erro ao carregar uma lista de tarefas ou projetos](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22882.html?lang=pt-BR) | Novo artigo | Saiba como resolver a mensagem de erro *Ops. Algo deu errado*, ao carregar uma lista de tarefas ou projetos. |
| Setembro de 2023 | [A publicação da fila de solicitações é desfeita](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22753.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução do problema em que uma fila de solicitações no Adobe Workfront tem sua publicação desfeita. |
...
* Mix Modeler [notas de versão](https://experienceleague.adobe.com/docs/mix-modeler/using/releases/latest.html)
* Mix Modeler [documentação do produto](https://experienceleague.adobe.com/docs/mix-modeler.html?lang=en)
...
| Publicado | Aplicativo | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |---------- |
| Setembro de 2023 | Aplicativos | [Crie um fluxo de trabalho simples com o Power Automate](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/simple-workflow-power-automate.html?lang=en) | Vídeo | Saiba como membros não técnicos de sua organização podem criar fluxos de trabalho simples que se conectam a outros sistemas usando os conectores pré-criados do Microsoft Power Automate que estão incluídos gratuitamente no Acrobat Sign. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Setembro de 2023 | [Ideia criativa do Jumpstart](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/jumpstart-ideation.html?lang=en) | Vídeo | Saiba como começar a desenvolver conteúdo criativo para uma campanha de marketing. |
| Setembro de 2023 | [Tutoriais de caso de uso do Adobe Express](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/overview-express-use-case-tutorials.html?lang=en) | Vídeo | Descubra como equipes diferentes em sua organização podem se beneficiar do Adobe Express. |
| Setembro de 2023 | [Criar conteúdo atraente de merchandising](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/compelling-merchandise.html) | Vídeo | Saiba como uma equipe de comércio pode criar facilmente imagens atraentes para um novo conjunto de inventário em sua loja online. |
| Setembro de 2023 | [Capacite as equipes de marketing para criar conteúdo multicanal](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/multi-channel-marketing-content.html) | Vídeo | Saiba como as equipes de marketing de eventos podem criar conteúdo exclusivo para atrair visualizadores para eventos online. |
| Setembro de 2023 | [Capacite as equipes distribuídas a localizar conteúdo](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/localized-marketing-content.html?lang=en) | Vídeo | Saiba como as equipes de marketing de campo distribuído podem personalizar facilmente o conteúdo em sua região para campanhas de marketing locais. |
