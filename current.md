...
Última atualização: **sábado, 15 de março de 2024**
...
* [[!DNL Adobe Analytics]](#analytics) (lançado) **13 de março**)
* [[!DNL Adobe Customer Journey Analytics]](#cja) (lançado) **13 de março**)
...
Atualizado em **sábado, 15 de março de 2024**

+++Detalhes

* **WORKFRONT** | Workshop do cliente | _Administrador 101 - Faça suas perguntas sobre o Workfront_ | Você perdeu as sessões anteriores do Admin 101 ou ainda tem dúvidas? Junte-se a nós para um acompanhamento de uma hora de duração da série, onde resumiremos as sessões e as abriremos para perguntas e respostas. | **20 de março às 8:00 (PT)** | [Inscreva-se](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,1YdEYKuO-0KE3ermHwWEfg,UN_LlgnRokKfDGTmj7vhVg,XjCFMeclLEmuHQZslDQYHw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
* **ANALYTICS** | Criadores de experiências: intercâmbio de habilidades | _Skill Exchange (intercâmbio de habilidades) no Adobe Summit para Adobe Analytics_ | Em 28 de março de 2024, sediaremos o Adobe Analytics Skill Exchange no Summit em Las Vegas! Registre-se agora para saber mais sobre dicas, truques e práticas recomendadas de clientes e campeões do Analytics. | **28 de março às 9:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=952%20953)

* **EXPERIENCE MANAGER** | Criadores de experiências: intercâmbio de habilidades | _Intercâmbio de habilidades na Adobe Summit para AEM_ | Em 28 de março de 2024, sediaremos o AEM Skill Exchange no Summit em Las Vegas! Registre-se agora para aprender dicas, truques e práticas recomendadas de clientes e especialistas em AEM. | **28 de março às 9:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=950%20951)

* **EXPERIENCE MANAGER** | Criadores de experiências: intercâmbio de habilidades | _Skill Exchange no Adobe Summit para o Marketo Engage_ | Em 28 de março de 2024, sediaremos o Marketo Engage Skill Exchange no Summit em Las Vegas! Registre-se agora para conhecer dicas, truques e práticas recomendadas de clientes do Marketo Engage e especialistas. | **28 de março às 9:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=954%20955)

* **WORKFRONT** | Criadores de experiências: intercâmbio de habilidades | _Skill Exchange (intercâmbio de habilidades) no Adobe Summit para Workfront_ | Em 28 de março de 2024, sediaremos o Adobe Workfront Skill Exchange no Summit em Las Vegas! Registre-se agora para conhecer dicas, truques e práticas recomendadas dos clientes do Workfront. | **28 de março às 9:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=956%20957)

* **WORKFRONT** | Evento da comunidade | _Conecte-se: chat administrativo para marketing e criação_ | Você é administrador de sistema de uma equipe de marketing ou criação? Esta sessão orientada ao cliente conectará você com outros administradores para discutir práticas recomendadas, bem como dicas e truques. | **5 de abril às 9h (PT)** | [Registrar](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,S3qiBpspOUyiG7Vl_PtPXg,rFPUK2gma0OCogFhuCyzjw,nTcEntnvgkePuH01JzrsQw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
Saiba mais sobre [Cadeia de fornecimento de conteúdo](https://business.adobe.com/solutions/adobe-genstudio.html), Adobe uma solução completa para acelerar e simplificar seu conteúdo com IA gerativa e automação inteligente.

+++Detalhes

| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Fevereiro de 2024 | [Tutorials da cadeia de fornecimento de conteúdo](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | Vídeos | Exibir tutoriais da cadeia de suprimento de conteúdo no Experience League. A cadeia de fornecimento de conteúdo é uma solução completa de Adobe para acelerar e simplificar sua cadeia de fornecimento de conteúdo com IA gerativa e automação inteligente. |
...
* [quarta-feira, 30 de janeiro de 2024](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2024/02142024.html#status)
...
**Permissões Experience Platform**

Correções:

* Agora é possível pesquisar uma credencial de API por nome ao visualizar ou modificar suas credenciais.
* As informações de associação do grupo de usuários agora estão disponíveis para cada função ao visualizar a lista de funções de um usuário na guia Funções. A variável **[!UICONTROL Remover Função]** A opção está desativada para usuários que receberam uma função somente por meio de um grupo de usuários.
...
| Publicado | Nome | Tipo | Descrição |
|---------|----|----|-----------|
| Fevereiro de 2024 | [[!UICONTROL Assimilação de valor padrão] in [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23641.html) | Novo artigo | Saiba como definir um valor padrão durante a assimilação no [!DNL Adobe Experience Platform (AEP)], em especial para [!DNL upsert] operações, você deve usar mapeamentos explícitos no processo de assimilação de dados. |
...
[!DNL Analytics] data de lançamento: **13 de março de 2024**
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Fevereiro de 2024 | [Criar elementos de dados em tags Experience Platform para implementação do Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html) | Vídeo | Crie elementos de dados para o seu [!DNL Analytics] implementação em tags com base nas variáveis e eventos documentados em um documento Referência de design de solução (SDR). |
| Fevereiro de 2024 | [Criar uma regra de página global nas tags Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-a-global-page-rule-in-tags.html) | Vídeo | Saiba como configurar uma regra de página global para pontos de dados que você deseja enviar para a Adobe Analytics em cada página usando as tags Experience Platform. |
| Fevereiro de 2024 | [Validar a regra de carregamento de página global nas tags Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/validating-your-global-page-load-rule-in-tags.html) | Vídeo | Saiba como validar sua regra de carregamento de página global com o depurador da Experience Platform. |
| Fevereiro de 2024 | [Criar regras de tags de Experience Platform para eventos bem-sucedidos](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-success-events.html?lang=en) | Vídeo | Saiba como usar regras em tags para rastrear eventos de conversão (eventos bem-sucedidos) em seu site. |
| Fevereiro de 2024 | [Usar o doPlugins e plug-ins de implementação nas tags da Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/use-doplugins-and-implementation-plugins.html?lang=pt-BR) | Vídeo | Saiba mais sobre os benefícios de usar a função doPlugins e adicione plug-ins de implementação do Analytics para enriquecer a coleção de dados. |
| Fevereiro de 2024 | [Definir filtros internos do URL](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/set-internal-url-filters.html?lang=en) | Vídeo | saiba mais sobre as configurações relacionadas aos referenciadores, definindo-os como referenciadores internos (para alimentar os relatórios de definição de caminho) ou referenciadores externos (para alimentar os relatórios do referenciador/domínio de referência). |
| Fevereiro de 2024 | [Tags - seu assistente pessoal](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/analytics/analysis-workspace/tips-and-tricks/tags-your-personal-assistant.html) | Artigo | Descubra como as tags Experience Platform podem simplificar sua análise digital, atuando como seu assistente pessoal para encontrar o que você precisa com eficiência. Jeff Bloomer, Adobe Analytics Champion, compartilha insights especializados sobre como maximizar o potencial da ferramenta para o seu benefício. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|----|----|-----------|
| Fevereiro de 2024 | [O link (URL) do projeto gerou alterações quando você compartilha um espaço de trabalho do Adobe Analytics](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html) | Novo artigo | Este artigo oferece uma solução para o problema do Adobe Analytics em que um link de projeto é alterado sempre que um link de projeto do espaço de trabalho é recuperado em um espaço de trabalho compartilhado do Adobe Analytics. Você pode usar o link recém-gerado ou o link gerado anteriormente para acessar o projeto de destino. |
...
[!DNL Customer Journey Analytics] data de lançamento: **13 de março de 2024**
...
| Publicado | Aplicativos | Nome | Tipo | Descrição |
| ----------| ---------- | ---------- | ---------- |---------- |
| Fevereiro de 2024 | Experience Manager Assets | [Workflows de início automático](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/auto-start-workflows.html?lang=pt-BR) | Vídeo | Saiba como os workflows de início automático estendem o processamento de ativos no [!DNL AEM as a Cloud Service] chamando automaticamente o fluxo de trabalho personalizado após o upload ou o reprocessamento, após a conclusão do processamento de ativos. |
| Fevereiro de 2024 | Experience Manager Sites | [Configurar criação de documentos](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html) | Vídeo | Um guia sobre como configurar a criação de documentos para autores. |
| Fevereiro de 2024 | Experience Manager Sites | [Fluxos de trabalho de documento](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | Vídeo | Saiba como usar workflows de documentos com criação de documentos AEM. |
| Fevereiro de 2024 | Experience Manager Sites | [Versões do documento](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Vídeo | Saiba como criar versões de documentos criados usando a criação de documentos AEM. |
| Fevereiro de 2024 | AEM CS | [Cloud 5 - pesquisa de terceiros](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html) | Vídeo | Explore como a pesquisa de terceiros pode ser integrada melhor em Edge Delivery Services. |
| Fevereiro de 2024 | Experience Manager Assets | [Eventos do AEM Assets para integração do PIM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/assets-pim-integration.html) | Vídeo | Saiba como integrar o AEM Assets a um sistema de terceiros, como um sistema de Gerenciamento de informações de produto (PIM) ou de Gerenciamento de linha de produto (PLM), para atualizar metadados de ativos usando eventos nativos de AEM IO. |
| Fevereiro de 2024 | AEM Headless | [Campos personalizados](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Vídeo | Saiba como criar campos personalizados no Editor de fragmento de conteúdo do AEM. |
| Fevereiro de 2024 | Experience Manager, AEM Cloud Manager, Marketo Engage | [Dicas e truques do especialista em AEM - Uso de logs no Cloud Manager](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/cloud-manager-using-logs.html) | Vídeo | Veja essas dicas de Rami EL Gamal, seu colega campeão de AEM. Neste vídeo, Rami mostra como baixar logs no Cloud Manager, enquanto compartilha dicas de práticas recomendadas ao longo do caminho. |
| Fevereiro de 2024 | AEM CS | [Cloud 5 - Monitoramento de usuário real (RUM)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=en) | Vídeo | Explore a análise de Monitoramento de usuário real (RUM) que o Adobe oferece aos sites AEM fornecidos com Edge Delivery Services e como o RUM pode ser usado para melhorar um site. |
| Fevereiro de 2024 | Experience Manager Forms | [Gerar PDF com dados do componente principal com base no envio de formulário](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html) | Vídeo | Mesclar dados do envio do formulário baseado no componente principal com o modelo XDP no fluxo de trabalho. |
| Fevereiro de 2024 | AEM Cloud Manager | [Práticas recomendadas e dicas do especialista em AEM - Preparação e planejamento de uma migração para o AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Vídeo | Explore conselhos de especialistas e práticas recomendadas do seu colega campeão de AEM, Wilson Faure. Neste vídeo, ele aborda as complexidades do planejamento e da preparação para a migração para o AEM as a Cloud Service. |
| Fevereiro de 2024 | Experience Manager Sites | [Cloud 5 - Trabalhadores de borda](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | Vídeo | Explore a importância dos trabalhadores de borda no AEM Sites e no Edge Delivery Services e como integrá-los aos seus sistemas de back-end. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Fevereiro de 2024 | [[!DNL CDN] modelo em [!UICONTROL Configuração do aplicativo] não salva](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | Novo artigo | Saiba mais sobre a solução alternativa quando a variável [!DNL CDN] modelo em [!UICONTROL Configuração do aplicativo] não pode ser salvo. |
| Fevereiro de 2024 | [Causas do JDK 11 `NoClassDefFoundError` [!DNL AEM] 6.5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | Novo artigo | Saiba como instalar o [!DNL CXF] pacotes externamente para resolver o problema da `NoClassDefFoundError` após uma atualização para [!DNL Java™] 11 com [!DNL AEM] 6,5x. |
| Fevereiro de 2024 | [Como qualificar um [!DNL AEM as Cloud Service] Tíquete de suporte](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | Novo artigo | Saiba como qualificar totalmente um tíquete para que o suporte possa processar e entender o problema rapidamente e quais informações são necessárias. |
| Fevereiro de 2024 | [Saiba como alterar o servidor e [!DNL JVM] fuso horário para Europa/Paris em [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Novo artigo | Saiba como alterar o servidor e [!DNL JVM] fuso horário para Europa/Paris em [!DNL AEM as a Cloud Service]. |
| Fevereiro de 2024 | [Os workflows são definidos como &quot;não editáveis&quot; após a implantação do código](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Novo artigo | Saiba mais sobre como resolver o [!DNL AEM] problema em que, após criar um Fluxo de trabalho no [!DNL AEM] seguido por uma implantação de código, a variável [!UICONTROL Fluxo de trabalho] é exibido como &quot;Não editável&quot;. Como prática recomendada, você deve manter [!UICONTROL Fluxo de trabalho] modelos na base de código consistentes em vários ambientes, para que você não precise recriar [!UICONTROL Fluxos de trabalho] por cada ambiente. |
| Fevereiro de 2024 | [[!DNL DDoS] sobrecarga de ataque ou bot [!DNL AEM] com tráfego](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | Novo artigo | Saiba mais sobre como depurar esse problema ativando o registro em log habilitado no nível do Dispatcher e siga etapas para melhorar o armazenamento em cache do Dispatcher, o que ajuda a evitar interrupções causadas por picos de tráfego. |
| Fevereiro de 2024 | [Problemas e soluções comuns de assimilação de ativos](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | Novo artigo | Saiba mais sobre o mais comum [!DNL AEM] Cenários de problemas de assimilação de ativos e como analisá-los, incluindo alto processamento, alto volume, grande [!DNL DAM] repositórios e muitos autores simultâneos. |
| Fevereiro de 2024 | [Limite máximo de variações, política de desempenho e retenção de [!UICONTROL Fragmentos de conteúdo]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | Novo artigo | Saiba mais sobre o limite máximo para o número de variações permitidas em um único [!UICONTROL fragmento de conteúdo], se várias variações contribuem para a lentidão do site e se há alguma política de retenção para exclusões [!UICONTROL fragmentos de conteúdo]. |
| Fevereiro de 2024 | [[!UICONTROL Solicitação de exclusão] fluxo de trabalho acionado na exclusão de conteúdo](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | Novo artigo | Saiba mais sobre quando um usuário faz logon e exclui uma página ou ativo no [!DNL AEM], o &quot;[!UICONTROL Solicitação de exclusão]&quot;O workflow é acionado. |
| Fevereiro de 2024 | [[!DNL HTML] arquivo armazenado em [!DNL CRX] não abre no navegador, é baixado](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | Novo artigo | A [!DNL HTML] arquivo armazenado diretamente no [!DNL Oak] O repositório do não abre no navegador. Em vez disso, ele é baixado em [!DNL AEM 6.1 SP2] e versões posteriores. |
| Fevereiro de 2024 | [[!DNL Adobe Experience Manager]: `WARN` mensagem de `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | Novo artigo | Saiba mais sobre o problema ao [!DNL AEM 6.5] inicialização, `WARN` As mensagens são exibidas várias vezes na variável `error.log`. |
| Fevereiro de 2024 | [[!DNL Adobe Experience Manager]: o nó com `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | Novo artigo | Saiba mais sobre o problema quando, em alguns casos, nós com uma `sling:resourceType` valor de `wcm/msm/components/ghost` existe. Este artigo explica como o nó é criado. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Fevereiro de 2024 | [Conectar e executar consultas no banco de dados do Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/remote-db-connection-execute-queries.html?lang=en) | Vídeo | Saiba como se conectar a um projeto na nuvem do Adobe Commerce, despejar um banco de dados para uso externo e mascarar as PII e removê-las. |
| Fevereiro de 2024 | [Integração técnica de Commerce Cloud e transferência de hardware - Cronograma do processo de inicialização](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-commerce-cloud/technical-onboarding-hardware-handoff/launch-process-timeline.html) | Vídeo | Saiba mais sobre a integração técnica do Adobe Commerce Cloud para a linha do tempo do processo de lançamento. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Fevereiro de 2024 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html?lang=pt-BR) | Novos artigos | Novos artigos sobre como aplicar patches disponíveis no [!DNL QPT] 1.1.44 [!DNL QPT] 1.1.45 e [!DNL QPT] 1.1.46 foram publicados e encontram-se nas respectivas seções. |
| Fevereiro de 2024 | [Várias linhas no banco de dados para a mesma entidade](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/database/multiple-rows-in-database-for-same-entity.html) | Novos artigos | Este artigo fornece uma solução para o problema em que há várias linhas para a mesma ID de entidade no banco de dados. |
| Fevereiro de 2024 | [Recommendations [!DNL JS] erros após a atualização para o Adobe Commerce versão 2.4.5](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | Novos artigos | Este artigo fornece uma correção para quando, após a atualização para o Adobe Commerce (todos os métodos de implantação), há [!DNL JS] erros no console relacionados aos módulos/unidades Recommendations do produto. |
...
Tutoriais em vídeos novos ou atualizados publicados para o Adobe Campaign.
...
| Fevereiro de 2024 | Interface do Campaign Web | [Explorar a interface da Web do Campaign](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/getting-started/explore-the-web-ui.html) | Vídeo | Saiba como acessar e navegar na interface Campaign Web e personalizar as listas de inventário. Descubra o Assistente de conhecimento habilitado para IA. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|----|----|-----------|
| Fevereiro de 2024 | [Não é possível visualizar a janela dos modelos de entrega corretamente quando conectado a [!DNL Campaign Console] via [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Novo artigo | Saiba mais sobre a solução para o problema ao se conectar ao [!DNL Adobe Campaign Console] via [!DNL VPN], você não pode ver os dados dos templates do delivery na janela. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|----|----|-----------|
| Fevereiro de 2024 | [Encapsula funções ao criar expressões usando o operador &quot;+&quot;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23749.html) | Novo artigo | Saiba como qualquer chamada de função deve ser encapsulada com parênteses ao usar o operador &quot;+&quot;. |
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Fevereiro de 2024 | [!DNL Adobe Firefly] | [Descubra o Adobe Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html?lang=en) | Vídeo | Adobe Firefly Descubra o futuro da criatividade com a IA gerativa, projetada para o uso comercial seguro e para a inovação. |
| Fevereiro de 2024 | [!DNL Adobe Firefly] | [Página de aterrissagem](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | Vídeo | Saiba como começar a usar o Adobe Firefly. |
| Fevereiro de 2024 | [!DNL Adobe Firefly] | [Preenchimento generativo](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html?lang=en) | Vídeo | Saiba como usar o Preenchimento genérico para adicionar, expandir ou remover conteúdo de suas imagens de forma não destrutiva usando prompts de texto simples. O preenchimento generativo permite aprimorar sua criatividade e criar projetos extraordinários. |
| Fevereiro de 2024 | [!DNL Adobe Firefly] | [Recolorir geradora](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html?lang=en) | Vídeo | Saiba como pré-visualizar instantaneamente variações de cores diversas para sua embalagem de produto, cartazes ou arte-final em arquivos vetoriais. A recoloração gerativa permite que você rescolore o mais rápido possível. Experimente ideias prontas para uso, idealize em torno de diferentes temas ou paletas e produza várias variações num piscar de olhos. |
| Fevereiro de 2024 | [!DNL Adobe Firefly] | [Exemplos de como usar o Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html?lang=en) | Vídeo | Saiba como você pode usar o Firefly para criar apresentações inspiradoras do PowerPoint, quadros de humor, ideação, protetores de tela e muito mais. |
| Fevereiro de 2024 | [!DNL Adobe Firefly] | [Efeitos de texto](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/text-effects.html?lang=en) | Vídeos | Saiba como criar texto exclusivo e inspirador para seus projetos usando prompts de texto simples. Efeitos de texto permite aprimorar sua criatividade e criar textos extraordinários para seus projetos. |
