...
* [[!DNL Experience League] events](#events) (atualizado **19 de setembro**)
...
Lançamento planejado para: **28 de setembro de 2022**
...
Atualizado: **1 de setembro de 2022** - Consulte as [Notas de versão e os logs de alteração](https://aep-sdks.gitbook.io/docs/release-notes) dos SDKs móveis da Adobe Experience Platform.
...
| [!UICONTROL Recomendações] | (Contas do [!DNL Google Ads]; recurso beta) Em [!UICONTROL Insights e relatórios] > [!UICONTROL Recomendações beta], você pode:<ul><li>Ver as principais características de todas as recomendações que não foram implementadas em uma conta do [!DNL Google Ads].</li><li>Aplicar e ignorar as recomendações de uma conta.</li><li>Visualize logs de cada recomendação que foi aplicada para uma conta.</li></ul><br>Recommendations suportado:<li><strong>Categoria de recomendação; Tipo de Recomendação; Descrição</strong></li><li>Anúncios e extensões; CALL_EXTENSION; Adicionar extensões de chamada ao Campaign</li><li>Anúncios e extensões; CALLOUT_EXTENSION; Adicionar extensões de chamada para campanha</li><li>Anúncios e extensões; OTIMIZE_AD_ROTATION; Usar rotações de anúncio otimizadas</li><li>Anúncios e extensões; SEARCH_AD RESPONSIVO; Adicionar nova publicidade de pesquisa responsiva</li><li>Anúncios e extensões; RESPONSIVE_SEARCH_AD_ASSET; Adicione ativos responsivos de pesquisa e anúncio</li><li>Anúncios e extensões; SITELINK_EXTENSION; Adicionar extensões do sitelink ao Campaign</li><li>anúncios e extensões; TEXT_AD; Adicionar sugestões de publicidade</li><li>Lance &amp; budget; ORÇAMENTO DE CAMPANHA; Corrigir campanhas limitadas por orçamento</li><li>Lance &amp; budget; ENHANCED_CPC_OPT_IN; Oferta com CPC aprimorado</li><li>Lance &amp; budget; ORÇAMENTO PRECASTING_CAMPAIGN; Corrija campanhas que devem se tornar limitadas pelo orçamento no futuro</li><li>Lance &amp; budget; ORÇAMENTO MARGINAL ROI_CAMPAIGN; Ajuste o orçamento da campanha para aumentar o ROI</li><li>Lance &amp; budget; MAXIMIZAR CLIQUES EM OPT_IN; Oferta com o máximo de cliques</li><li>Lance &amp; budget; MAXIMIZAR CONVERSÕES OPT_IN; Oferta com o máximo de conversões</li><li>Lance &amp; budget; MOVE_UNUSED_BUDGET; Mover não utilizado para orçamentos restritos</li><li>Lance &amp; budget; TARGET_CPA_OPT_IN; Lance com o Target CPA</li><li>Lance &amp; budget; TARGET_ROAS_OPT_IN; Lance com o ROAS do Target</li><li>Palavras-chave e definição de metas; PALAVRA-CHAVE; Adicionar novas palavras-chave</li><li>palavras-chave e definição de metas; SEARCH_PARTNERS_OPT_IN; Expandir alcance com parceiros de pesquisa da Google</li><li>palavras-chave e definição de metas; PALAVRA-CHAVE USE_BROAD MATCH; Use uma ampla correspondência para campanhas baseadas em conversão com <strong>Licitação Baseada Em Conversão Totalmente Automatizada</strong></li> |
...
| Setembro de 2022 | [Gerar um token de acesso](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/generating-an-access-token.html?lang=pt-BR) | Vídeo | Na parte 4 do _Guia de início rápido incorporado ao Acrobat Sign_, aprenda a gerar um token de acesso que pode ser usado com a API do Acrobat Sign. | Serviços de documento |
