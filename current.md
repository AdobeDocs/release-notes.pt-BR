...
Última atualização: **sábado, 22 de março de 2024**
...
* **ANALYTICS** | Criadores de experiências: The Skill Exchange | _Skill Exchange no Adobe Summit para o Adobe Analytics_ | Em 28 de março de 2024, realizaremos o Adobe Analytics Skill Exchange no Summit em Las Vegas! Faça a pré-inscrição agora para aprender dicas, truques e práticas recomendadas de clientes e especialistas do Analytics. | **28 de março às 09:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=952%20953)

* **EXPERIENCE MANAGER** | Criadores de experiências: The Skill Exchange | _Skill Exchange no Adobe Summit para o AEM_ | Em 28 de março de 2024, realizaremos o AEM Skill Exchange no Summit em Las Vegas! Faça a pré-inscrição agora para aprender dicas, truques e práticas recomendadas de clientes e especialistas do AEM. | **28 de março às 09:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=950%20951)

* **EXPERIENCE MANAGER** | Criadores de experiências: The Skill Exchange | _Skill Exchange no Adobe Summit para o Marketo Engage_ | Em 28 de março de 2024, realizaremos o Marketo Engage Skill Exchange no Summit em Las Vegas! Faça a pré-inscrição agora para aprender dicas, truques e práticas recomendadas de clientes e especialistas do Marketo Engage. | **28 de março às 09:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=954%20955)

* **WORKFRONT** | Criadores de experiências: The Skill Exchange | _Skill Exchange no Adobe Summit para Workfront_ | Em 28 de março de 2024, realizaremos o Adobe Workfront Skill Exchange no Summit em Las Vegas! Faça a pré-inscrição agora para aprender dicas, truques e práticas recomendadas dos clientes do Workfront. | **28 de março às 09:00 (PT)** | [Inscreva-se](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=956%20957)

* **WORKFRONT** | Evento da comunidade | _Conecte-se: chat administrativo para marketing e criação_ | Você é administrador de sistema de uma equipe de marketing ou criação? Esta sessão orientada ao cliente conectará você com outros administradores para discutir práticas recomendadas, bem como dicas e truques. | **5 de abril às 09:00 PT** | [Inscreva-se](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,S3qiBpspOUyiG7Vl_PtPXg,rFPUK2gma0OCogFhuCyzjw,nTcEntnvgkePuH01JzrsQw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
Saiba mais sobre a [Cadeia de suprimento de conteúdo](https://business.adobe.com/solutions/adobe-genstudio.html), uma solução completa da Adobe para acelerar e simplificar seu conteúdo com a IA generativa e automação inteligente.
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Fevereiro de 2024 | [Criar elementos de dados em tags da Experience Platform para implementação do Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html?lang=pt-BR) | Vídeo | Crie elementos de dados para sua implementação do [!DNL Analytics] em tags com base nas variáveis e eventos documentados em um documento de Referência de design de solução (SDR). |
| Fevereiro de 2024 | [Criar uma regra de página global em tags da Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-a-global-page-rule-in-tags.html?lang=pt-BR) | Vídeo | Saiba como configurar uma regra de página global para pontos de dados que você deseja enviar para o Adobe Analytics em cada página usando tags da Experience Platform. |
| Fevereiro de 2024 | [Validar a regra de carregamento de página global em tags da Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/validating-your-global-page-load-rule-in-tags.html?lang=pt-BR) | Vídeo | Saiba como validar sua regra de carregamento de página global com o depurador da Experience Platform. |
| Fevereiro de 2024 | [Criar regras de tags da Experience Platform para eventos de sucesso](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-success-events.html?lang=pt-BR) | Vídeo | Aprenda como usar regras em tags para rastrear eventos de conversão (eventos de sucesso) em seu site. |
...
| Fevereiro de 2024 | [Definir filtros internos do URL](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/set-internal-url-filters.html?lang=pt-BR) | Vídeo | Aprenda sobre as configurações relacionadas aos referenciadores, definindo-os como referenciadores internos (para alimentar os relatórios de caminho) ou externos (para alimentar os relatórios de referenciador/domínio referenciador). |
| Fevereiro de 2024 | [Tags: seu assistente pessoal](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/analytics/analysis-workspace/tips-and-tricks/tags-your-personal-assistant.html?lang=pt-BR) | Artigo | Descubra como as tags da Experience Platform podem simplificar sua análise digital, atuando como um assistente pessoal para encontrar o que você precisa com eficiência. Jeff Bloomer, especialista em Adobe Analytics, compartilha insights especializados sobre como maximizar o potencial da ferramenta para o seu benefício. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|----|----|-----------|
| Fevereiro de 2024 | [O link (URL) do projeto gerou alterações ao compartilhar um espaço de trabalho do Adobe Analytics](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html?lang=pt-BR) | Novo artigo | Este artigo oferece uma solução para o problema do Adobe Analytics em que um link de projeto é alterado sempre que um link de projeto do espaço de trabalho é recuperado em um espaço de trabalho compartilhado do Adobe Analytics. É possível usar o link recém-gerado ou o link gerado anteriormente para acessar o projeto de destino. |
...
Data de lançamento do [!DNL Customer Journey Analytics]: **13 de março de 2024**
...
| Publicado | Aplicativos | Nome | Tipo | Descrição |
| ----------| ---------- | ---------- | ---------- |---------- |
| Fevereiro de 2024 | Experience Manager Assets | [Workflows de início automático](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/auto-start-workflows.html?lang=pt-BR) | Vídeo | Saiba como os fluxos de trabalho de início automático estendem o processamento de ativos no [!DNL AEM as a Cloud Service] chamando automaticamente o fluxo de trabalho personalizado após o upload ou o reprocessamento, depois da conclusão do processamento do ativo. |
| Fevereiro de 2024 | Experience Manager Sites | [Configurar criação de documento](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html?lang=pt-BR) | Vídeo | Um guia sobre como configurar a criação de documentos para autores. |
| Fevereiro de 2024 | Experience Manager Sites | [Fluxos de trabalho de documento](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html?lang=pt-BR) | Vídeo | Saiba como usar fluxos de trabalho de documentos com a criação de documentos no AEM. |
| Fevereiro de 2024 | Experience Manager Sites | [Versões do documento](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html?lang=pt-BR) | Vídeo | Saiba como criar versões de documentos criados usando a criação de documentos no AEM. |
| Fevereiro de 2024 | AEM CS | [Nuvem 5: pesquisa de terceiros](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html?lang=pt-BR) | Vídeo | Confira como a pesquisa de terceiros pode ser melhor integrada ao Edge Delivery Services. |
| Fevereiro de 2024 | Experience Manager Assets | [Eventos do AEM Assets para integração do PIM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/assets-pim-integration.html?lang=pt-BR) | Vídeo | Saiba como integrar o AEM Assets a um sistema de terceiros, como um sistema de Gerenciamento de informações de produto (PIM) ou de Gerenciamento de linha de produto (PLM), para atualizar metadados de ativos usando eventos nativos do AEM IO. |
| Fevereiro de 2024 | AEM Headless | [Campos personalizados](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=pt-BR) | Vídeo | Saiba como criar campos personalizados no Editor de fragmento de conteúdo do AEM. |
| Fevereiro de 2024 | Experience Manager, AEM Cloud Manager, Marketo Engage | [Dicas e truques do especialista em AEM: uso de logs no Cloud Manager](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/cloud-manager-using-logs.html?lang=pt-BR) | Vídeo | Confira essas dicas de Rami EL Gamal, seu colega especialista em AEM. Neste vídeo, Rami mostra como baixar logs no Cloud Manager, enquanto compartilha dicas de práticas recomendadas ao longo do caminho. |
| Fevereiro de 2024 | AEM CS | [Nuvem 5: Monitoramento de usuário real (RUM)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=pt-BR) | Vídeo | Confira as análises de Monitoramento de usuário real (RUM) que a Adobe oferece aos seus sites do AEM fornecidos com Edge Delivery Services e como o RUM pode ser usado para melhorar um site. |
| Fevereiro de 2024 | Experience Manager Forms | [Gerar PDF com dados do componente principal com base em envios de formulários](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html?lang=pt-BR) | Vídeo | Mescle dados do envio de formulário baseado em componentes principais com o modelo XDP no fluxo de trabalho. |
| Fevereiro de 2024 | AEM Cloud Manager | [Práticas recomendadas e dicas do especialista em AEM: preparação e planejamento de uma migração para o AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html?lang=pt-BR) | Vídeo | Confira conselhos de especialistas e práticas recomendadas do seu colega e especialista em AEM, Wilson Faure. Neste vídeo, ele aborda as complexidades do planejamento e da preparação para a migração para o AEM as a Cloud Service. |
| Fevereiro de 2024 | Experience Manager Sites | [Nuvem 5: trabalhadores de borda](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=pt-BR) | Vídeo | Confira a importância dos trabalhadores de borda no AEM Sites e no Edge Delivery Services e como integrá-los aos seus sistemas de back-end. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Fevereiro de 2024 | O modelo do [[!DNL CDN]  na [!UICONTROL Configuração do aplicativo] não salva](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução alternativa quando o modelo do [!DNL CDN] na [!UICONTROL Configuração do aplicativo] não pode ser salvo. |
