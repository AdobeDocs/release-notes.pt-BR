...
* [Certification at Adobe](https://experienceleague.adobe.com/pt-br/certification-home)
* [Adobe product security vulnerabilities](https://helpx.adobe.com/br/security.html)
...
| Junho de 2025 | [!DNL Experience Manager] | [Inovações orientadas por IA e IA de geração na Experience Manager](https://experienceleague.adobe.com/pt-br/playlists/experience-manager-all-gen-ai-driven-innovations) | Novo vídeo | Pequenos clipes do Adobe Summit 2025. |
...
| Junho de 2025 | [!DNL Experience Manager Sites] | [Criar um guia de criação ao vivo em [!DNL Sites]](https://experienceleague.adobe.com/pt-br/docs/experience-manager-learn/sites/expert-resources/authoring-guide-in-sites) | Novo vídeo | O AEM Champion Brett Birschbach compartilha as práticas recomendadas para a criação de um guia de criação ao vivo no Adobe Experience Manager (AEM) Sites. |
...
| Maio de 2025 | [Noções básicas sobre RTO e RPO para AEM as a Cloud Service](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26664) | Novo artigo | Saiba mais sobre o RTO (Recovery Time Objetive, objetivo de tempo de recuperação) e o RPO (Recovery Point Objetive, objetivo de ponto de recuperação) da AEM Cloud. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Junho de 2025 | [Anúncios de novos produtos](https://experienceleague.adobe.com/pt-br/docs/commerce-learn/tutorials/webinars-and-events/future-of-commerce/new-product-announcements) | Novo vídeo | Saiba mais sobre o Adobe Commerce as a Cloud Service e o Adobe Commerce Optimizer. |
...
| Junho de 2025 | [Reduzir drasticamente o custo](https://experienceleague.adobe.com/pt-br/docs/commerce-learn/tutorials/webinars-and-events/future-of-commerce/drastically-cut-costs) | Novo vídeo | Saiba como o Adobe Commerce as a Cloud Service pode reduzir bastante os custos. |
...
| Junho de 2025 | [Hospedagem pronta para HIPAA no Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/commerce-learn/tutorials/adobe-commerce-cloud/hippa-ready-hosting) | Novo vídeo | Saiba mais sobre a hospedagem pronta para HIPAA. A solução pronta para HIPAA na Adobe Commerce garante um comércio eletrônico seguro e compatível para empresas de assistência médica. |
...
| Maio de 2025 | [Renomeando um canal offline no Marketo Measure](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26444) | Novo artigo | Saiba como renomear um canal offline no Marketo Measure. |
...
| Maio de 2025 | [Resolvendo a falta de canais offline no Marketo Measure](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26397) | Novo artigo | Saiba mais sobre as soluções para o problema em que determinados canais offline estão ausentes durante a configuração. |
...
| Maio de 2025 | [Resolvendo a criação de vários pontos de contato para uma única campanha no Marketo Measure](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26359) | Novo artigo | Saiba como resolver pontos de contato duplicados para um único endereço de email no Marketo Measure. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Junho de 2025 | [Copiar um relatório](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/copy-a-report) | Novo vídeo | Saiba como criar rapidamente um novo relatório copiando e editando um relatório semelhante. |
| Junho de 2025 | [Criar atividades básicas de filtro](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-basic-filter-activity) | Novo artigo | Nesta atividade, você cria um filtro de projeto chamado &quot;Todos os projetos no portfólio de marketing&quot; na experiência de filtro Herdado. Isso mostrará todos os projetos no portfólio chamados &quot;Marketing Portfolio&quot;, independentemente do status. |
| Junho de 2025 | [Criar um relatório de matriz](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-matrix-report) | Novo vídeo | Saiba quando um relatório de matriz pode ser útil e como criar um relatório de matriz no Workfront. |
...
| Junho de 2025 | [Criar uma exibição básica](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-basic-view) | Novo vídeo | Saiba o que é uma visualização, como criá-la e como compartilhá-la com outros usuários no Workfront. |
...
| Junho de 2025 | [Criar um relatório de tarefa](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-task-report) | Novo vídeo | Saiba como criar um relatório de tarefas com um filtro complexo e encontrar os relatórios que você cria no Workfront. |
...
* Mix Modeler [Maio - junho de 2025 - Notas de versão](https://experienceleague.adobe.com/pt-br/docs/mix-modeler/using/releases/latest?lang=pt-BR)
...
Consulte [Tutoriais do Creative Cloud para corporações](https://experienceleague.adobe.com/pt-br/docs/creative-cloud-enterprise-learn/cce-learning-hub/overview?lang=pt-BR) para encontrar os tutoriais mais recentes.
