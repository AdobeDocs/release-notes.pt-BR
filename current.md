...
| [!DNL Experience Cloud] | [IA de agente](https://experienceleague.adobe.com/pt-br/docs/core-services/interface/features/agentic-ai) | Saiba mais sobre o Agente de suporte do produto e o Data Insights Agent (IA de agente). |
...
| Julho de 2025 | [Introdução ao Real-Time CDP Collaboration](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/collaboration/real-time-cdp-collaboration-intro) | Novo vídeo | Obtenha uma introdução ao Adobe Real-Time CDP Collaboration, um aplicativo de colaboração de dados criado com propósitos específicos que permite descobrir e ativar públicos-alvo de alto valor e usar recursos de medição para gerar resultados tangíveis. |
...
| Julho de 2025 | [Real-Time CDP Collaboration: Processo e pessoas](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/collaboration/rtcdp-collaboration-process-and-people) | Novo vídeo | Para equipes de mídia paga e de agências: uma olhada rápida no Real-Time CDP — o que é, como funciona e como as fontes de dados e os públicos-alvo alimentam os fluxos de trabalho de colaboração. |
...
* [Vídeo de visão geral da versão mais recente do AEM CS](https://experienceleague.adobe.com/pt-br/docs/events/aemcs-release-update-recordings/overview?lang=pt-BR)
...
| Junho de 2025 | [Adobe Experience Manager: diferenciando problemas de produtos e personalizações antes de entrar em contato com o Suporte ao Cliente da Adobe](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-27017) | Novo artigo | Saiba como distinguir se um problema do AEM deriva do produto principal, do código personalizado ou de integrações de terceiros. |
...
| Julho de 2025 | [Criar um produto de pacote](https://experienceleague.adobe.com/pt-br/docs/commerce-learn/tutorials/getting-started/create-products/create-bundle-product) | Novo vídeo | Saiba como criar um produto combinado usando a REST API e o administrador do Commerce. |
| Julho de 2025 | [Criar um produto de cartão-presente](https://experienceleague.adobe.com/pt-br/docs/commerce-learn/tutorials/getting-started/create-products/create-gift-card-product) | Novo vídeo | Saiba como criar um produto de cartão-presente usando a REST API e o administrador do Adobe Commerce. |
| Julho de 2025 | [Demonstração completa da Conexão de Dados do Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/commerce-learn/tutorials/getting-started/capabilities/data-connection) | Novo vídeo | Assista a uma demonstração completa dos recursos da Adobe Commerce Data Connection. |
...
| Junho de 2025 | [Solucionar problemas de instalação de Serviços de Pagamento](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26826) | Novos artigos | Saiba mais sobre as soluções para o problema em que ocorrem erros durante a instalação dos Serviços de pagamento. |
| Junho de 2025 | [Dados do relatório de Serviços de Pagamento Atrasados](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26837) | Novos artigos | Saiba mais sobre as soluções para o problema quando os dados do relatório de Serviços de pagamento atrasados ocorrem no Adobe Commerce. |
...
| Junho de 2025 | [Solução de problemas [!DNL Upgrade Compatibility Tool] erros](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26849) | Novos artigos | Saiba mais sobre as soluções para o problema de erros ao usar o [!DNL Upgrade Compatibility Tool]. |
...
| Junho de 2025 | [Como verificar por que o  [!DNL cron]  foi desabilitado](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26854) | Novos artigos | Saiba mais sobre soluções para problemas com o [!DNL cron] no Adobe Commerce em produtos de infraestrutura em nuvem. |
...
| Junho de 2025 | [Campos bloqueados (esmaecidos) no Administrador do Commerce](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26879) | Novos artigos | Saiba mais sobre as soluções para o problema que impede a modificação de campos bloqueados (esmaecidos) no Administrador do Commerce. |
...
| Junho de 2025 | [Plug-in do Composer contra ataques de Confusão de Dependência](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26900) | Novos artigos | Saiba mais sobre as soluções para problemas com o plug-in compositor lançado para ataques de Confusão de dependência. |
...
| Junho de 2025 | [Falha na implantação: não é possível aplicar o patch MDVA-43395](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26911) | Novos artigos | Saiba mais sobre as soluções para o problema em que tentar aplicar o patch MDVA-43395 resulta em falha na implantação. |
...
| Junho de 2025 | [[!DNL MySQL] as tabelas são muito grandes](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26945) | Novos artigos | Saiba mais sobre as soluções para o problema quando qualquer tabela do [!DNL MySQL] é maior que 1 GB. |
...
| Junho de 2025 | [Entenda como o Centro de Mensagens afeta perfis ativos no Adobe Campaign v8](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26812) | Novo artigo | Saiba como o Centro de mensagens afeta perfis ativos no Adobe Campaign v8. |
...
* [!DNL Marketo Engage] [cronograma de lançamento](https://experienceleague.adobe.com/pt-br/docs/marketo/using/release-notes/release-schedule?lang=pt-BR)
...
| Julho de 2025 | [Criar um relatório de calendário personalizado](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/calendar-reports/creating-custom-calendars.html?lang=pt-BR) | Novo vídeo | Saiba como criar seu próprio calendário personalizado. |
| Julho de 2025 | [Entender a interface do relatório de calendário](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/reporting/calendar-reports/tour-of-the-interface) | Novo vídeo | Conheça a interface do calendário, incluindo agrupamentos, visualizações e ações. |
| Julho de 2025 | [Compreender opções adicionais de relatório de calendário](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/calendar-reports/additional-calendar-options.html?lang=pt-BR) | Novo vídeo | Saiba como copiar, editar, compartilhar e excluir um calendário. |
...
* Mix Modeler [maio - julho de 2025 - Notas de versão](https://experienceleague.adobe.com/pt-br/docs/mix-modeler/using/releases/latest?lang=pt-BR)
