...
* **Adobe Workfront** | _Planejamento Workfront: A Smart Start_ | Conheça as práticas recomendadas básicas de configuração da equipe de gerenciamento de produtos da Workfront. | 31 de julho de 2025 - 10:00 AM MT | [Registrar](https://events.teams.microsoft.com/event/adbabe72-e591-464e-87f8-1f1947d49f38@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **Adobe Marketo Engage (Várias Soluções)** | _Marketo e Mochas: Salesforce Sync_ | Dicas e estratégia para sincronizar e otimizar o Salesforce + Marketo. | 31 de julho de 2025 - 10:00 AM MT | [Registrar](https://adobeevents.adobeconnect.com/eeb0ucvtg1l0/event/registration.html?campaign-id=ExL)

* **Adobe Workfront** | _Simplicidade de design: como Kohler fez uma recriação dos resumos do Creative_ | Estudo de caso sobre a breve inovação de processos criativos no Workfront. | 6 de agosto de 2025 - 12:00 PM MT | [Registrar](https://events.teams.microsoft.com/event/fbfa9ecf-7042-4ed8-b7a5-58351dae561f@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
| Julho de 2025 | [!DNL Journey Optimizer] | [Adicionar campos de formulário a modelos de canal de experiência baseados em código](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/form-fields-in-code-based-experiences) | Novo vídeo | Saiba como os desenvolvedores podem simplificar a colaboração com equipes de marketing, habilitando campos editáveis dentro de canais de experiência baseada em código. |
