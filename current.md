...
* [[!DNL Adobe Analytics]](#analytics) (lançamento em **15 de maio**)
* [[!DNL Adobe Customer Journey Analytics]](#cja) (lançamento em **15 de maio**)
...
* **WORKFRONT** | Evento da comunidade | _Círculo industrial do Adobe Workfront: varejo_ | Se você é cliente do Workfront no setor de varejo e tem interesse na solução coletiva de problemas e no compartilhamento de aprendizados com outros(as) admins, junte-se a nós para uma discussão aberta de 1 hora, liderada por admins da DSW e da Nordstrom. | **23 de maio, às 11h00 (PT)** | [Inscreva-se](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,vFfS8Q7qMUCtqS73wkJMig,sz-whm3Hyka_fhpfall8TA,DCY8aPpdN069tKqlYeJMyQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **WORKFRONT** | Bate-papo | _Bate-papo com perguntas e respostas da comunidade do Adobe Workfront: migração para a Adobe Business Platform_ | Junte-se a especialistas do Workfront na comunidade e faça perguntas sobre a Adobe Business Platform, a migração da sua organização para o Adobe Admin Console e muito mais. | **29 de maio, às 08h00 (PT)** | [Inscreva-se](https://experienceleaguecommunities.adobe.com/t5/workfront-events/workfront-coffee-break-wednesday-may-29th-at-8am-pt-best/ev-p/668763)
...
Confira os [próximos eventos](https://experienceleague.adobe.com/events/?lang=pt-BR) ou procure [gravações de eventos anteriores](https://experienceleague.adobe.com/en/docs/events/experience-league-recorded-events/overview?lang=pt-BR) na Experience League.
...
| Correções de erros | <ul><li>Melhores filtros de ambiente nas páginas de produto do Adobe Connect, Adobe Marketo e Adobe Sign.</li><li>Clicar na grade do histórico de 40 dias leva ao respectivo dia e aos eventos relevantes desse dia.</li><li>Aprimoramentos na interface</li></ul> |
...
| Maio de 2024 | [!DNL Experience Platform] | [Criar identidades](https://experienceleague.adobe.com/pt-br/docs/platform-learn/implement-web-sdk/tags-configuration/create-identities) | Artigo | Saiba como capturar identidades com o Adobe Experience Platform Web SDK. Capture dados de identidade com ou sem autenticação no site de demonstração Luma. |
| Maio de 2024 | [!DNL Experience Platform] | [Principais recursos da Adobe Experience Platform](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/intro-to-platform/key-capabilities) | Vídeo atualizado | Saiba como os principais recursos da Experience Platform agregam valor à sua empresa. |
...
| Maio de 2024 | [Criar uma cultura de dados e uma melhor referência de design de solução](https://experienceleague.adobe.com/br/docs/experiences-by-you/experiences-by-you/analytics/administration/admin-tips/better-sdr) | Artigo | Revolucione a estratégia de dados e capacite sua equipe a criar um documento sólido de referência de design de solução (SDR). Elimine falhas de medição e promova uma cultura colaborativa de dados por meio de metodologias passo a passo. |
| Maio de 2024 | [Análise de coorte no Analysis Workspace](https://experienceleague.adobe.com/br/docs/analytics-learn/tutorials/analysis-workspace/cohort-analysis/cohort-analysis-workspace) | Vídeo atualizado | Saiba como criar uma tabela de [!UICONTROL Análise de coorte] no Analysis Workspace. |
...
| Abril de 2024 | O calendário do [[!UICONTROL Report Builder] continua carregando após selecionar [!UICONTROL Datas fixas]](https://experienceleague.adobe.com/br/docs/experience-cloud-kcs/kbarticles/ka-23621) | Novo artigo | Saiba mais sobre o problema no qual o calendário do [!UICONTROL Report Builder] continua carregando após selecionar `[Fixed Dates]`. |
...
_Extension Manager no[!DNL AEM Sites]_

Conheça o novo [Extension Manager do  [!DNL AEM Sites]](https://developer.adobe.com/uix/docs/extension-manager/), que permite personalizar a configuração do AEM definindo extensões da interface.

O Extension Manager do [!DNL AEM Sites] permite que desenvolvedores(as) e profissionais acessem, gerenciem e personalizem [extensões da interface](https://developer.adobe.com/uix/docs/) criadas com o [Construtor de aplicativos da Adobe](https://developer.adobe.com/app-builder/) para aprimorar a funcionalidade do [!DNL AEM Sites].
...
| Abril de 2024 | [Como adicionar `stricthostcheck` in [!DNL AEMaaCS] Configuração do Dispatcher](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-24069) | Novo artigo | Saiba como adicionar `stricthostcheck` in [!DNL AEMaaCS] Configuração do Dispatcher. |
...
| Abril de 2024 | [Como [!DNL flush] o cache do Dispatcher quando houver farms com pastas de cache separadas](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-24023) | Novo artigo | Saiba como [!DNL flush] o cache do Dispatcher quando houver farms com pastas de cache separadas. |
...
**Versão de abril de 2024:** saiba mais sobre os recursos, melhorias e correções mais recentes nas [Notas de versão do Journey Optimizer](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/whats-new/release-notes?lang=pt-BR).
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Maio de 2024 | [Criar ações](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/journey-configuration/create-actions) | Vídeo | Saiba o que é uma ação, como usar as ações Editar perfil e Saltar no [!DNL Journey Optimizer] e como configurar uma ação personalizada. |
