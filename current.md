...
description: Saiba mais sobre as notas de versão mais recentes, os novos recursos e a nova documentação dos [!DNL Experience Cloud] produtos e serviços. Encontre ajuda e novos tutoriais sobre o [!DNL Experience Cloud], [!DNL Creative Cloud for enterprise] e [!DNL Document Cloud].
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Julho de 2022 | [Monitorar o encaminhamento de eventos](https://experienceleague.adobe.com/docs/platform-learn/data-collection/event-forwarding/monitor.html) | Vídeo | Saiba como monitorar o encaminhamento do evento na interface da Coleta de dados. | Coleta de dados |
| Julho de 2022 | [Monitorar assimilação de dados](https://experienceleague.adobe.com/docs/platform-learn/tutorials/monitoring/monitoring-dashboard.html) | Vídeo | Saiba como monitorar e rastrear dados que são assimilados no Adobe Experience Platform usando o painel de monitoramento. | Coleta de dados |
| Julho de 2022 | [Importar dados de amostra para a Adobe Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html?lang=pt-BR) | Artigo | Saiba como configurar um ambiente de caixa de proteção do Experience Platform com dados de amostra. Usando uma coleção do Postman, você pode criar grupos de campos, esquemas, conjuntos de dados e, em seguida, importar dados de amostra para o Experience Platform. | Experience Platform |
| Julho de 2022 | [Correspondência de segmentos recebendo dados](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/segment-match-receiving-data.html) | Vídeo | Com a Correspondência de segmentos, os dados podem ser compartilhados por seus parceiros estratégicos. Neste vídeo, saiba como aprovar e receber os dados, e onde você pode visualizá-los e adicioná-los aos seus próprios segmentos. | Experience Platform - Segmentos |
| Julho de 2022 | [Pergunte aos especialistas: Conexões do Real-Time CDP](https://experienceleague.adobe.com/docs/experience-league-live-events/events/episodes/exl-live-episode-06-23-22.html?lang=en) | Vídeo Experience League LIVE | Neste segundo de três sessões do livestream relacionadas à coleta de dados, nossos especialistas favoritos oferecem uma visão abrangente da RTCDP do Adobe [!UICONTROL Conexões], onde os clientes podem encaminhar eventos para destinos que não sejam Adobe usando um sistema de gerenciamento de tags do lado do servidor. | Coleta de dados |
...
| -----------| ---------- | ---------- | ---------- |
| Julho de 2022 | [Melhorias no Fluxo em 2022](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analyzing-customer-journeys/flow-improvements.html) | Vídeo | Saiba mais sobre algumas das grandes melhorias na [!UICONTROL Fluxo] visualização. As melhorias incluem a possibilidade de configurar o início ou o fim do caminho em que está interessado, filtrar uma coluna para incluir ou excluir um item específico e configurações avançadas pré-configuráveis. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Julho de 2022 | [Configurar o painel do item seguinte e anterior](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/panels/configure-next-previous-item-panel.html) | Vídeo | Saiba como configurar o painel de itens seguinte e anterior no [!DNL Customer Journey Analytics]. Esse painel gera tabelas e visualizações para identificar o item seguinte ou anterior para um valor de dimensão específico. |
| Julho de 2022 | [Criar uma anotação](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/annotations/create-an-annotation.html?lang=en) | Vídeo | Saiba como criar uma anotação em seu [!DNL Customer Journey Analytics] projetos quando eventos como inicializações de campanha, problemas de dados e feriados ocorrem. Esse recurso informa seus usuários sobre variações de métrica nessas datas ou intervalos de datas. |
| Julho de 2022 | [Criar um filtro rápido](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/filters/create-a-quick-filter.html) | Vídeo | Crie filtros rápidos diretamente nos seus projetos do [!DNL Customer Journey Analytics] e evite a complexidade do construtor de filtros completo. |
...
* [Vídeo Visão geral da versão de junho de 2022](https://video.tv.adobe.com/v/344308/?quality=12) para obter um resumo da versão 2022.6.

Vídeos de atualização de produto mais antigos:

* [Vídeo Visão geral da versão de maio de 2022](https://video.tv.adobe.com/v/343321/?quality=12) para obter um resumo dos recursos adicionados na versão 2022.5.0 (maio de 2022).
...
* A [nova interface do usuário](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/content-fragments-console.html?lang=en) O agora está disponível para administradores de conteúdo e autores de conteúdo gerenciarem com eficiência (realizar ações como publicar, cancelar a publicação, copiar e mover), pesquisar/filtrar e criar fragmentos de conteúdo para casos de uso sem cabeçalho.

* O novo [Componente Índice](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/tableofcontents.html?lang=en) funciona não somente com o [!UICONTROL Componentes principais] mas com todos os componentes, renderiza automaticamente o índice nas páginas de conteúdo. E, como ele é renderizado no lado do servidor e totalmente armazenado em cache pelo dispatcher, também é eficiente carregar.

### Experience Manager [!DNL Assets] como [!DNL Cloud Service]

Novos recursos no [!DNL Assets]:

* Experience Manager [!DNL Assets] O usa os recursos da Adobe Sensei AI para [distinguir entre cores em uma imagem e aplicá-las automaticamente como tags na assimilação](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/color-tag-images.html?lang=pt-BR). Essas tags permitem uma experiência de pesquisa aprimorada, com base na composição de cores da imagem. Você pode configurar o número de cores, dentro de um intervalo de uma a quarenta, que são marcadas em uma imagem, para que possa pesquisar por imagens com base nessas cores posteriormente.

### Experience Manager Forms as a Cloud Service

Novos recursos no [!DNL Forms]:

* [Integrar [!UICONTROL Forms adaptável] com o Microsoft® Power Automated](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/forms-microsoft-power-automate-integration.html?lang=en): Agora é possível configurar um Formulário adaptável para executar um fluxo da Microsoft® Power Automate Cloud no envio. O formulário adaptável configurado envia dados capturados, anexos e documentos de registro para o fluxo de nuvem do Power Automate para processamento. Ele ajuda a criar uma experiência personalizada de captura de dados, aproveitando o poder do Microsoft® Power Automate para criar lógicas comerciais sobre dados capturados e automatizar os fluxos de trabalho do cliente.

**Assistente para criar um formulário adaptável:** Você pode usar o assistente para usuários empresariais para criar rapidamente [!UICONTROL Forms adaptável]. O assistente fornece uma navegação de guia rápida para selecionar facilmente o modelo pré-configurado, o estilo, os campos e as opções de envio para criar um formulário adaptável.
...
* [!DNL Cloud Manager] agora, os usuários do podem acessar tutoriais em vídeo úteis do [!UICONTROL Welcome] cartão na página de aterrissagem a qualquer momento.

* O poder da [Restaurar conteúdo](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/backup.html?lang=en) A guia da página de detalhes do ambiente agora exibe uma lista útil de comandos git que permite que o usuário visualize as alterações localmente.
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Julho de 2022 | [Aproveite ao máximo o gerenciamento de fluxos de trabalho corporativos](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/content-and-commerce/2022/workflow.html?lang=en) | Vídeo | Saiba mais sobre os benefícios de usar fluxos de trabalho para o gerenciamento de ativos e como criá-los rapidamente. | AEM - Gerenciamento do fluxo de trabalho da experiência |
| Julho de 2022 | [Fornecer experiências headless com a Adobe Experience Manager](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/content-and-commerce/2022/headless.html?lang=en) | Vídeo | Saiba mais sobre o gerenciamento de experiência sem periféricos usando o Experience Manager mais recente [!UICONTROL Fragmento de conteúdo] Melhorias e a nova API GraphQL para a entrega de conteúdo sem interface. | Experience Manager [!DNL Sites] |
| Julho de 2022 | [Faça com que os metadados funcionem para sua empresa no Adobe Experience Manager Assets](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/content-and-commerce/2022/metadata.html?lang=en) | Vídeo | Saiba como aproveitar ao máximo seus metadados no AEM Assets, reduzindo a carga de trabalho para marcar ativos e tornando seus ativos mais pesquisáveis. | Experience Manager [!DNL Assets] |
| Julho de 2022 | [Aplicativo iOS](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/example-apps/ios-swiftui-app.html) | Vídeo | Exemplos de aplicativos são uma ótima maneira de explorar os recursos headless do Adobe Experience Manager. Este aplicativo iOS demonstra como consultar conteúdo usando AEM [!UICONTROL APIs GraphQL] uso de consultas persistentes. | Experience Manager [!DNL Assets], [!DNL Sites] |
| Julho de 2022 | [Aplicativo Android™](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/example-apps/android-app.html) | Vídeo | Este aplicativo Android™ demonstra como consultar conteúdo usando o [!UICONTROL APIs GraphQL] de AEM. | Experience Manager [!DNL Assets], [!DNL Sites] |
| Julho de 2022 | [Configuração do OSGi para Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/deploying/configuring-osgi.html?lang=en) | Vídeo | Saiba como configurar o OSGI para AEM CS. Por exemplo, saiba mais sobre o gerenciamento de pacotes OSGi e sobre o gerenciamento das configurações de componentes OSGi por meio de arquivos de configuração que fazem parte de um projeto de código AEM. | AEM as a Cloud Service |
| Julho de 2022 | [Substituir propriedades do modelo de dados de formulário](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/adaptive-forms/override-fdm-values.html?lang=en) | Vídeo | Saiba como substituir as propriedades do modelo de dados de formulário para facilitar o teste de um modelo de dados de formulário em relação a diferentes pontos de extremidade. | AEM [!DNL Forms] |
...
* [Notas de versão do Experience Manager Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/release-notes/current.html?lang=en)
...
* [Guia do Usuário do Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/introduction.html?lang=en)
...
* [[!DNL Experience Manager Guides]](https://experienceleague.adobe.com/docs/experience-manager-guides-learn/videos/overview.html?lang=en) - tutoriais na Experience League
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Julho de 2022 | [Guia de introdução ao Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-admin/start/guide-overview.html) | Documentação do produto | Um guia destinado a comerciantes e administradores de sistema novos no Adobe Commerce e Magento Open Source. Obtenha uma visão geral da plataforma em sua perspectiva e algumas informações detalhadas sobre os recursos básicos que permitem uma loja funcional. |
| Julho de 2022 | [Guia do usuário do Page Builder](https://experienceleague.adobe.com/docs/commerce-admin/page-builder/guide-overview.html) | Documentação do produto | Saiba mais sobre os recursos do Page Builder, incluindo uma apresentação de três partes para a criação de componentes básicos de conteúdo. Este guia é para administradores. Ele assume uma compreensão básica da configuração e funcionalidade principais do Adobe Commerce. |
| Julho de 2022 | [Guia B2B para Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-admin/b2b/guide-overview.html) | Guia de administração | Obtenha informações detalhadas sobre a instalação e habilitação deste módulo, incluindo a configuração e o gerenciamento de seus recursos. |
| Julho de 2022 | [B2B para Adobe Commerce - tutoriais](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/company-accounts.html?lang=en) | Vídeo (vários) | Saiba mais sobre o [!UICONTROL Empresas] no Adobe Commerce. É possível gerenciar as contas da empresa e qualquer solicitação pendente de aprovação é exibida na parte superior da lista. |
| Julho de 2022 | [Usar a ferramenta Correção de qualidade](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/tools/quality-patch-tool.html) | Tipo | Saiba mais sobre o [!UICONTROL Ferramenta Correção de Qualidade], que é uma ferramenta de linha de comando que fornece patches de qualidade para Adobe Commerce e Magento Open Source. |
| Julho de 2022 | [O painel da ferramenta de análise do site](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/tools/site-wide-analysis-tool.html) | Vídeo | Saiba mais sobre a Ferramenta de análise do site. Esse recurso é uma ferramenta de autoatendimento proativa e de repositório central que inclui informações e recomendações detalhadas do sistema para garantir a segurança e a operabilidade de sua instalação do Adobe Commerce. |
| Julho de 2022 | [Usar serviços de pagamento](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/payment-services.html) | Vídeo | Saiba como usar [!UICONTROL Serviços de pagamento] para reduzir a sobrecarga operacional, aumente a receita. |
| Julho de 2022 | [Gerenciar status do pedido](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/orders/order-status.html) | Tipo | Saiba como verificar o status do pedido e seus detalhes, e como alterar o status de um pedido, se necessário. |
| Julho de 2022 | [Ferramentas de marketing](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/marketing/catalog-price-rules.html?lang=en) | Vídeo (vários) | Saiba mais sobre como criar uma regra de preço de catálogo, regras de preço do carrinho, gerenciar regras de produto relacionadas, pesquisa ao vivo e muito mais. |
| Julho de 2022 | [Inovações na personalização de conteúdo que agregam valor aos negócios](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/content-and-commerce/2022/content-perosonalization.html?lang=en) | Vídeo | Assista às apresentações do Skill Builder e saiba mais sobre as inovações recentes na solução Conteúdo do Adobe que ajuda a democratizar a criação de conteúdo, tornar o delivery omnicanal uma tarefa fácil e dimensionar a personalização. |
| Julho de 2022 | [Gerenciamento de catálogo](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/catalog/seo-url-rewrites.html) | Vídeos | Saiba mais sobre o gerenciamento de catálogos no Adobe Commerce. crie uma categoria, gerencie produtos em uma categoria, gerencie o inventário e muito mais. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Julho de 2022 | [Criar públicos](https://experienceleague.adobe.com/docs/target-learn/tutorials/audiences/create-audiences.html) | Vídeo | Saiba como criar e salvar públicos-alvo personalizados em [!DNL Target] para usar em suas atividades. |
| Julho de 2022 | [Personalizar e automatizar com o Adobe Target](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/data-and-insights/2022/personalize.html?lang=en) | Vídeo | Saiba mais sobre os conceitos principais de automatização e otimização de recursos do Adobe Target usando [!UICONTROL Direcionamento automático] e [!UICONTROL Personalizações automáticas]. |
...
* [Versão v8.3 do Campaign](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/release-notes.html?lang=pt-BR)
* [Campaign Standard versão 22.2](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=pt-BR)
* [Versão de junho do Painel de controle do Campaign](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=en)
* [tutoriais e cursos](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=pt-BR#tutorials-campaign) no Experience League
...
| Publicado | Nome | Tipo | Descrição | Aplicativos |
| -----------| ---------- | ---------- | ---------- |---------- |
| Julho de 2022 | [Painel de controle do Campaign para modelos de hospedagem híbrida](https://experienceleague.adobe.com/docs/control-panel-learn/control-panel/control-panel-for-hybrid-hosting-models.html) | Vídeo | Saiba como ativar o Painel de controle para modelos de hospedagem híbrida do Adobe Campaign, acessar o Painel de controle e desbloquear os principais recursos. | Painel de controle |
| Julho de 2022 | [Monitorar entradas e latência](https://experienceleague.adobe.com/docs/control-panel-learn/control-panel/performance-monitoring/monitor-throughputs-and-latency.html?lang=pt-BR) | Vídeo | Saiba como monitorar as saídas de delivery e as latências de mensagem transacional da instância do Campaign. | Painel de controle |
| Julho de 2022 | [Monitorar fluxos de trabalho para otimizar o uso de recursos](https://experienceleague.adobe.com/docs/control-panel-learn/control-panel/performance-monitoring/monitor-workflows.html?lang=pt-BR) | Vídeo | Saiba como monitorar o uso de armazenamento temporário de seus fluxos de trabalho e onde definir as configurações do fluxo de trabalho para evitar problemas de banco de dados ou fluxo de trabalho na instância. | Painel de controle |
| Julho de 2022 | [Desenvolver e personalizar modelos de dados no Adobe Campaign Classic](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/data-models.html?lang=en) | Vídeo (eventos Skill Builder) | Participe desta sessão com nosso treinador do Campaign para saber como desenvolver um schema de dados dentro de um modelo de dados no Campaign Classic. | Campaign Classic v7 |
| Julho de 2022 | [Práticas recomendadas e estratégias de capacidade de delivery que geram resultados](https://experienceleague.adobe.com/docs/adobe-campaign-insider-events/events/deliverability-best-practices.html) | Vídeo | Saiba como minimizar as inúmeras horas que se passam no planejamento e produção de suas campanhas de email. | Campaign Classic v7 |
| Julho de 2022 | [Alinhe seu marketing entre canais com o Adobe Campaign Classic](https://experienceleague.adobe.com/docs/adobe-campaign-insider-events/events/cross-channel.html?lang=en) | Vídeo | Assista a esse webinar de mergulho profundo com foco em fluxos de trabalho, automação, personalização e medição para clientes da Adobe Campaign Classic. | Campaign Classic v7 |
| Julho de 2022 | [Tempo economizando dicas de um profissional!](https://experienceleague.adobe.com/docs/adobe-campaign-insider-events/events/tips.html?lang=en) | Vídeo | Comece seu novo ano com dicas e truques de um profissional de Adobe Campaign! Saiba mais sobre como criar e lançar campanhas e como fornecer experiências entre canais mais significativas e personalizadas. | Campaign Classic v7 |
| Julho de 2022 | [Integrações do Adobe Campaign com um ecossistema de marketing](https://experienceleague.adobe.com/docs/adobe-campaign-insider-events/events/integrations.html?lang=en) | Vídeo | Saiba mais sobre as integrações do Adobe Campaign com um ecossistema de marketing. As soluções de marketing entre canais, como o Adobe Campaign, não devem se manter isoladas de outras tecnologias ou equipes. Não permita que sistemas díspares impeçam a compreensão completa de um cliente e interrompam as estratégias entre canais. | Campaign Classic v7 |
| Julho de 2022 | [Destaque do cliente da Adobe Campaign Standard - Microsoft](https://experienceleague.adobe.com/docs/adobe-campaign-insider-events/events/microsoft.html?lang=en) | Vídeo | Ouça a equipe de marketing da Microsoft® para compartilhar como ela usa o Adobe Campaign Standard, sua arquitetura, princípios orientadores e práticas recomendadas. | Campaign Standard |
| Julho de 2022 | [Destaque do cliente Adobe Campaign - Parcs centrais](https://experienceleague.adobe.com/docs/adobe-campaign-insider-events/events/center-parcs.html?lang=en) | Vídeo | Ouça os clientes da Adobe Campaign compartilharem como superar desafios, se ajustarem ao novo normal, se tornarem mais eficientes no gerenciamento de campanhas e agregarem valor através da Adobe Campaign. | Campaign Classic v7 |
| Julho de 2022 | [Adobe Campaign Classic V7 vs V8](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/classic-v7-vs-v8.html?lang=en) | Vídeo | Saiba mais sobre as últimas atualizações do produto e entenda as diferenças entre o V7 e o V8 de nossos Gerentes de produto. | Campaign Classic v7, Campaign v8 |
| Julho de 2022 | [Keynote - Tendências e inovação da Jornada do cliente em B2B &amp; B2C](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/keynote.html?lang=en) | Vídeo | Saiba mais sobre as últimas tendências no Gerenciamento de Jornadas do cliente em B2B e B2C. Veja as inovações mais recentes em aplicativos principais do jornada e a Adobe Experience Cloud e plataforma mais amplas. | Marketo, Campaign Classic v7, Campaign v8 |
| Julho de 2022 | [Principais dicas e truques para o Adobe Campaign Standard](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/tips-and-tricks.html?lang=en) | Vídeo | Conecte-se à sua instância do Adobe Campaign Standard e descubra as práticas recomendadas relacionadas ao direcionamento, personalização e fadiga de marketing para ter um melhor uso do ACS. | Campaign Standard |
| Julho de 2022 | [Equipe, habilidades e design organizacional necessários para oferecer suporte ao marketing entre canais](https://experienceleague.adobe.com/docs/adobe-campaign-insider-events/events/team-skills-org-design.html) | Vídeo | Aprenda como ter poder para se envolver onde, quando e como quiser. Saiba mais sobre a importância de ter uma organização de marketing que suporte o planejamento, a execução e a medição. | Campaign Classic v7, Campaign v8, Campaign Standard |
...
Novos vídeos, tutoriais ou cursos publicados do Adobe Journey Optimizer.

| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Julho de 2022 | [Configurar regras de frequência de mensagem](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channel-configuration/configure-frequency-rules.html) | Vídeo | Saiba como criar, ativar, testar e relatar regras de frequência. Entenda como determinar quais regras de frequência serão herdadas por uma mensagem. |
| Julho de 2022 | [Configurar, criar e entregar mensagens SMS](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-messages/configure-author-and-deliver-sms-messages.html) | Vídeo | Saiba como configurar, criar e incluir mensagens SMS nas jornadas do cliente. |
| Julho de 2022 | [Compatibilidade com palavras-chave de entrada para SMS](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-messages/inbound-keyword-support-for-sms.html) | Vídeo | Entenda como a compatibilidade nativa com palavras-chave de entrada (iniciar, parar, reiniciar) para SMS funciona. |
...
Novos vídeos, tutoriais ou cursos publicados do Adobe Marketo.

| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Julho de 2022 | [Experiências B2B com Marketo Engage e Adobe Experience Cloud](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/b2b-experiences.html?lang=en) | Vídeo | Obtenha uma explicação passo a passo das integrações entre o Marketo Engage e o aplicativo Adobe Experience Cloud, e quais pontos problemáticos serão resolvidos. | Marketo Engage |
| Julho de 2022 | [Melhor juntos - Adobe Marketo Engage e Real-Time CDP](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/b2b-campaigns.html?lang=en) | Vídeo | Saiba como orquestrar campanhas B2B com Marketo Engage e RT-CDP (edição B2B) e quais são os principais casos de uso e vantagens desbloqueadas. | Marketo, Real-time Customer Data Platform |
...
| Publicado | Nome | Tipo | Descrição | Aplicativo |
| -----------| ---------- | ---------- | ---------- |---------- |
| Julho de 2022 | [Uso da função de aprovador](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-sending/add-an-approver.html?lang=en) | Vídeo (atualizado) | Saiba como enviar um documento por meio de um processo de aprovação. | Adobe Sign |
| Julho de 2022 | [Configurar um formulário web](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/webform.html) | Vídeo (atualizado) | Saiba como criar um documento que pode ser assinado eletronicamente em seu site. | Adobe Sign |
| Julho de 2022 | [Usar a função de delegador](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-sending/delegate-signature.html?lang=en) | Vídeo (atualizado) | Descrição | Adobe Sign |
| Julho de 2022 | [Assinando eletronicamente um documento](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-signing/electronically-sign-a-document.html?lang=en) | Vídeo (atualizado) | Saiba como é fácil assinar um documento enviado para você com o Acrobat Sign. | Adobe Sign |
| Julho de 2022 | [Ativo e em execução para administradores do Acrobat Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/up-and-running-admin.html?lang=en) | Vídeo (atualizado) | Saiba mais sobre as sete principais áreas nas quais os administradores devem se concentrar para ativar e executar rapidamente no Acrobat Sign. | Adobe Sign |
| Julho de 2022 | [Send for Signature no Outlook](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/send-for-signature-with-outlook.html?lang=en#) | Vídeo (atualizado) | Saiba como simplificar os fluxos de trabalho de documentos enviando um documento para assinatura diretamente no Microsoft® Outlook. | Adobe Sign |
| Julho de 2022 | [Preenchendo e fazendo logon no Outlook](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/fill-and-sign-doc-microsoft-outlook.html?lang=en) | Vídeo (atualizado) | Saiba como simplificar fluxos de trabalho de documentos preenchendo e assinando um formulário diretamente no Microsoft Outlook. | Adobe Sign |
| Julho de 2022 | [Criação e gerenciamento de grupos](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-and-manage-groups.html?lang=en) | Vídeo (atualizado) | Saiba como criar grupos, adicionar usuários a grupos e editar configurações de grupos. | Adobe Sign |
| Julho de 2022 | [Delegar assinatura para outra pessoa](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-signing/delegate-signing.html?lang=en) | Vídeo (atualizado) | Saiba como delegar a assinatura de um documento a outra pessoa. | Adobe Sign |
