...
Esta página ajuda você a se manter atualizado sobre as informações de lançamento de produto, eventos e oportunidades de aprendizado na Experience League. Para receber uma notificação por email mensal sobre atualizações nessa página, assine a [Atualização prioritária de produto da Adobe](https://www.adobe.com/subscription/priority-product-update.html).
...
* **[!DNL WORKFRONT]** | Webinário | _Quais as novidades do Adobe Workfront 23.10?_ | **5 de outubro às 10:00 (ET)** | [Inscreva-se](https://event.on24.com/wcc/r/4338212/18470D85C5958448AE20FC2AF0DA9977?partnerref=EXL)

* **[!DNL EXPERIENCE MANAGER]** | Webinário | _Expressos e Experience Manager: atualização para o Dynamic Media_ | **5 de outubro às 23:00 (MDT)** | [Inscreva-se](https://register.gotowebinar.com/register/401473910088026710?source%3CExL)
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Setembro de 2023 | Destinos | [Visão geral dos destinos](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/understanding-destinations.html?lang=pt-BR) | Vídeo | Saiba mais sobre os tipos de destino que você pode usar para tornar os dados do Real-Time CDP, da Experience Platform e de tags compatíveis com uma grande variedade de casos de uso. |
| Setembro de 2023 | Destinos | [Configuração de um destino de exportação do conjunto de dados na Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-dataset-export-destination.html?lang=pt-BR) | Vídeo | Saiba mais sobre a configuração, o fluxo de trabalho e os casos de uso para exportar conjuntos de dados da Adobe Experience Platform para um local de armazenamento na nuvem usando uma conexão de destino. |
| Setembro de 2023 | Coleção de dados | [Utilização de fluxos de trabalho de início rápido na Coleção de dados](https://experienceleague.adobe.com/docs/platform-learn/data-collection/event-forwarding/quick-start-workflows.html?lang=pt-BR) | Vídeo | Saiba mais sobre os casos de uso avançados para aproveitar ao máximo os fluxos de trabalho de início rápido do [!DNL Facebook] ([!DNL Meta]) na [!UICONTROL coleção de dados] |
...
|---------|--------|---------|---------|
| Setembro de 2023 | [AEP - Composição de público-alvo é de somente leitura - Quais permissões são necessárias?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22841.html?lang=pt-BR) | Novo artigo | Saiba quais permissões são necessárias ao acessar a seção [!UICONTROL Públicos-alvo] para compor um novo público-alvo. |
| Setembro de 2023 | Os [[!UICONTROL Rastreamentos de destino] não aparecem no Adobe Experience Platform Debugger](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22635.html?lang=pt-BR) | Novo artigo | Saiba mais sobre a solução do problema em que a guia [!UICONTROL Rastreamento de destinos] não aparece no Adobe Experience Platform Debugger. |
...
* Se um pipeline estiver em andamento, o botão Enviar da caixa de diálogo Ativação concluída será desativado e informará que a data de ativação não pode ser definida devido ao pipeline em execução.
...
**Artigos fundamentais da base de conhecimento**
