...
Última atualização: **sexta-feira, 27 de fevereiro de 2025**
...
* [[!DNL Experience League] eventos e atualizações](#events) (**26 de fevereiro**)
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Fevereiro de 2025 | [!DNL AI Assistant] | [Obtenha insights operacionais com o Assistente de IA](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/ai-assistant/operational-insights) | Novo vídeo | Saiba como usar o [!DNL AI Assistant] para descobrir insights operacionais sobre objetos comerciais, como públicos-alvo, conjuntos de dados, esquemas, destinos e jornadas na Adobe [!DNL Experience Platform]. |
| Fevereiro de 2025 | [!DNL Experience Platform] | [Regras de vinculação de gráfico de identidade: simulação de gráfico](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/identities/graph-linking-rules/graph-simulation) | Novo vídeo | Saiba como usar o simulador de gráficos para testar regras de vinculação do gráfico de identidade na [!DNL Experience Platform]. Experimente diferentes cenários e utilize definições de prioridade e configurações _exclusivas para cada gráfico_, a fim de descobrir quais regras são necessárias para evitar o colapso dos gráficos na sua empresa. |
...
|---------|----|----|-----------|
| Janeiro de 2025 | [Resolver discrepâncias da interface do fluxo de dados de transmissão na  [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25576) | Novo artigo | Saiba como resolver discrepâncias na interface do fluxo de dados, como durações de processamento imprecisas e status de assimilação incorretos na [!DNL AEP]. |
| Janeiro de 2025 | [Noções básicas sobre as opções de monitoramento de  [!DNL Experience Platform Solutions]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25523) | Novo artigo | Aprenda a monitorar o status do sistema e identificar problemas de desempenho programaticamente em ambientes da [!DNL Adobe Experience Platform (AEP)]. |
| Janeiro de 2025 | Assimilação de [[!UICONTROL fluxo de dados] da pasta de origem incorreta na  [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25581) | Novo artigo | Saiba como resolver o problema em que um [!UICONTROL fluxo de dados] configurado para assimilar dados do [!DNL Azure Blob Storage] lê arquivos de uma pasta incorreta. |
| Janeiro de 2025 | [Suporte para  [!DNL KMS-encrypted S3 buckets]  na  [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25534) | Novo artigo | Saiba mais sobre o suporte da [!DNL Adobe Experience Platform] para métodos de criptografia, detalhamento da assimilação de dados e as opções de exportação. |
| Janeiro de 2025 | [Como resolver erros  [!DNL DULE]  na  [!DNL Adobe Experience Platform]  para ativação de público-alvo](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25552) | Novo artigo | Saiba como resolver erros [!DNL DULE] devido a conflitos entre rótulos de dados e ações de marketing. |
| Janeiro de 2025 | [Campos não exibidos no  [!DNL AEP Segment Builder]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25544) | Novo artigo | Saiba como resolver o problema em que os atributos ou campos de um conjunto de dados não aparecem no [!DNL Segment Builder] da [!DNL Adobe Experience Platform], mesmo após uma assimilação de dados bem-sucedida. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Janeiro de 2025 | [O filtro de pesquisa de idioma não está funcionando no  [!DNL Adobe Experience Manager as a Cloud Service (AEMaaCS)]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25501) | Novo artigo | Saiba como resolver o problema em que o filtro de pesquisa de idioma do [!DNL Adobe Experience Manager as a Cloud Service] não funciona como esperado ao tentar procurar ativos pelo nome do idioma. |
| Janeiro de 2025 | [[!DNL Adobe Asset Link plug-in] Erro de rede: *[!DNL server is unreachable]*](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25506) | Novo artigo | Saiba como resolver problemas de conectividade com o plug-in [!DNL Adobe Asset Link] no [!DNL Adobe Photoshop]. |
| Janeiro de 2025 | [Como resolver problemas de conexão do link do ativo do  [!DNL Adobe Experience Manager (AEM)]  no  [!DNL InDesign]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25562) | Novo artigo | Saiba como resolver problemas de conexão intermitentes ao usar o [!DNL Adobe Asset Link] (AAL) no [!DNL InDesign]. |
| Janeiro de 2025 | [Limitações de extração de texto para  [!DNL PDF]s grandes no  [!DNL Adobe Experience Manager as a Cloud Service (AEMaaCS)]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25518) | Novo artigo | Saiba como resolver o problema de extração de textos incompletos de grandes documentos [!DNL PDF] no [!DNL Adobe Experience Manager as a Cloud Service] devido a limitações de caracteres. |
| Janeiro de 2025 | [Como permitir que usuários representem outros usuários no  [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25539) | Novo artigo | Saiba mais sobre a nova configuração da versão 2024 do [!DNL AEM as a Cloud Service], que permite que qualquer pessoa represente usuários no [!DNL AEM Author]. |
| Janeiro de 2025 | Perda de propriedade  [!DNL JCR]  [personalizada ao alterar a criação e replicar no  [!DNL AEMaaCS]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25541) | Novo artigo | Saiba como resolver o problema de perda de propriedades [!DNL JCR] personalizadas ao fazer alterações de criação e replicar o conteúdo no [!DNL Adobe Experience Manager as a Cloud Service] (AEMaaCS). |
| Janeiro de 2025 | [Resolver problemas de processamento de ativos no  [!DNL AEM as a Cloud Service - Assets]](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25525) | Novo artigo | Saiba como resolver o problema de processamento de ativos no módulo [!DNL Adobe AEM's Dynamic Media] devido a problemas de sincronização de senha. |
| Janeiro de 2025 | [[!UICONTROL Fragmentos de conteúdo] não removidos da guia de referências de ativos](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25533) | Novo artigo | Saiba como resolver o problema do [!DNL Adobe Experience Manager as a Cloud Service - Assets] no qual as referências aos [!UICONTROL fragmentos de conteúdo] são mantidas na guia de referências da interface de metadados de um ativo, mesmo depois de o ativo ter sido removido com êxito do fragmento de conteúdo. |
...
| Fevereiro de 2025 | [Introdução ao Inventory management](https://experienceleague.adobe.com/pt-br/docs/commerce-admin/inventory/introduction) | Novo artigo | Saiba como usar os recursos do Inventory management e gerenciar estoque em vários locais para que sua loja do Commerce reflita com precisão o inventário físico. |
| Fevereiro de 2025 | [Adobe Commerce Marketplace](https://experienceleague.adobe.com/pt-br/docs/commerce-admin/start/resources/commerce-marketplace) | Novo vídeo | Saiba mais sobre o Commerce Marketplace, que oferece a comerciantes uma série de soluções bem preparadas. Ele também fornece a desenvolvedores qualificados as ferramentas, a plataforma e o local ideal para criar um negócio próspero. |
...
| Publicado | Nome | Tipo | Descrição |
|---------|--------|---------|---------|
| Janeiro de 2025 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/pt-br/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/patches-available-in-qpt-tool-overview) | Novos artigos | Publicação de novos artigos sobre como aplicar as correções disponíveis no [!DNL QPT] 1.1.57 e [!DNL QPT] 1.1.58, os quais podem ser encontrados em suas respectivas seções. |
| Janeiro de 2025 | [*[!DNL Resolve Database Restore Failure: ERROR 1105 (HY000) - Maximum Writeset Size Exceeded]*na infraestrutura em nuvem do Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25651) | Novos artigos | Saiba como resolver o problema ao restaurar um backup do [!DNL MariaDB] em um cluster [!DNL Galera]. O erro `Maximum Writeset Size Exceeded` pode ocorrer devido a um limite de tamanho de transação de 2 GB. |
| Janeiro de 2025 | Verificações de back-end com o [[!DNL Fastly]  na infraestrutura em nuvem do Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25574) | Novos artigos | Saiba como resolver o problema quando as verificações de back-end da ferramenta de teste [!DNL Fastly] podem exibir erros relacionados à capacidade de armazenamento em cache e chaves substitutas. |
| Janeiro de 2025 | Problema com permissão de push do [[!DNL Git]  forçada na infraestrutura em nuvem do Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25609) | Novos artigos | Saiba como resolver desafios relacionados a permissões encontrados ao tentar realizar uma operação de push forçada na infraestrutura em nuvem do Adobe Commerce. |
| Janeiro de 2025 | [Como resolver problemas de criação de tíquete de suporte do Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25467) | Novos artigos | Saiba o que admins de sistema devem fazer quando não conseguirem criar tíquetes de suporte para o Adobe Commerce. |
| Janeiro de 2025 | [Como resolver erros *[!DNL queue file size limit exceeded]* em emails no Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25514) | Novos artigos | Saiba como resolver o problema ao manipular grandes anexos de email na infraestrutura em nuvem do Adobe Commerce, que resulta em erros como `queue file size limit exceeded` que interrompem a funcionalidade de email. |
| Janeiro de 2025 | [Erro de implantação ao atualizar para o  [!DNL OpenSearch 1.3]  na infraestrutura em nuvem do Adobe Commerce](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-25526) | Novos artigos | Saiba como resolver erros de implantação após atualizar o [!DNL OpenSearch] da versão 1.2 para a 1.3 na infraestrutura em nuvem do Adobe Commerce. |
...
| Fevereiro de 2025 | [Criar testes multivariados](https://experienceleague.adobe.com/pt-br/docs/target-learn/tutorials/activities/create-multivariate-tests) | Novo vídeo | Saiba como criar um teste multivariado (MVT) no Adobe Target. Saiba mais sobre as etapas para criar e interpretar MVTs. |
| Fevereiro de 2025 | [Criar atividades de direcionamento de experiência](https://experienceleague.adobe.com/pt-br/docs/target-learn/tutorials/activities/create-experience-targeting-activities) | Novo vídeo | As atividades de Direcionamento de experiência (XT) permitem que profissionais de marketing direcionem conteúdo específico para um público-alvo específico. Saiba mais sobre os benefícios das atividades de XT e como criá-las e usá-las. |
