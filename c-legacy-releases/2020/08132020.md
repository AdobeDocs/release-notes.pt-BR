...
>[!NOTE]
>
>Assine o [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html?lang=br) para ser notificado por email sobre lançamentos futuros.
...
| 21 de julho de 2020 | [Projetos de tradução](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html?lang=pt-BR) | Tutorial | Saiba como criar, editar e gerenciar um projeto de tradução para sua [!UICONTROL Cópia de idioma]. |
...
| 21 de julho de 2020 | [Atualização da cópia de idioma com inicializações](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/updating-language-copy.html?lang=pt-BR) | Tutorial | Saiba como atualizar, revisar e aprovar alterações em uma [!UICONTROL Cópia de idioma] com a ajuda de inicializações. |
| 21 de julho de 2020 | [Visão geral do gerenciamento de vários sites](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/language-copy-overview.html?lang=pt-BR) | Tutorial | Obtenha uma visão geral de como criar um site multilíngue usando a [!UICONTROL Cópia de idioma] no [!UICONTROL AEM Sites]. |
...
| 21 de julho de 2020 | [Criar uma Cópia de idioma](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-component-inheritance-live-copy.html?lang=pt-BR) | Tutorial | Descrição |
...
| 21 de julho de 2020 | [Criar uma página de Cópia de idioma](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/create-new-page-language-copy.html?lang=pt-BR) | Tutorial | Saiba como criar uma página em uma [!UICONTROL Cópia de idioma] existente e, em seguida, traduzir o conteúdo para outra [!UICONTROL Cópia de idioma]. |
...
| 21 de julho de 2020 | [Introdução ao Editor SPA](https://video.tv.adobe.com/v/3417758?quality=12&learn=on&captions=por_br) | Tutorial | Curso Introdução ao Editor SPA do AEM para desenvolvedores. |
