...
* [[!DNL Campaign]](#ac)
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html) (links para a ajuda da solução)
...
* [!DNL Target] - [!DNL Target] A ID da sessão agora será adicionada como parâmetro de dados de contexto &quot;a.target.sessionId&quot; no repositório [!UICONTROL Analytics para Target] ocorrência enviada para o Adobe Analytics.
...
Consulte as notas de versão do [!DNL Marketo] de [fevereiro de 2020](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) para obter mais informações.
