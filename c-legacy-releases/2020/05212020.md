...
>[!NOTE]
>
>Assine o [[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html) para ser notificado por email sobre lançamentos futuros.
...
* [Suporte a Atributos do cliente para GDPR](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/gdpr.html?lang=pt-BR) (Regulamento Geral sobre a Proteção de Dados)
...
| [Extensão Dark Mode para o Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/dark-mode-extension-for-analysis-workspace.html?lang=pt-BR) | Ative a extensão Dark Reader Chrome para tornar o Analysis Workspace escuro. |
