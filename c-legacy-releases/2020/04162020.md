...
| [Navegação](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html) | Explore as noções básicas de navegação no AEM Assets. |
...
Consulte as [!DNL Marketo] [notas de versão](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) para obter mais informações.
