...
| Publicado | Nome | Tipo | Descrição |
|---------|----|----|-----------|
| Agosto de 2025 | [Adobe Journey Optimizer: configurações de TTL para os conjuntos de dados de [!UICONTROL Perfil] e [!UICONTROL Data Lake] em novas sandboxes](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-26135) | Novo artigo | Saiba mais sobre como as configurações de tempo de vida (TTL) se aplicam aos conjuntos de dados de [!UICONTROL Perfil] e [!UICONTROL Data Lake] ao criar uma nova sandbox no AJO. |
