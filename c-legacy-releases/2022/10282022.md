...
| Recurso | Descrição |
| ------- | ----------- |
| [!UICONTROL Campanhas] | (Versão de 6 de outubro) Novas colunas de métrica relacionadas ao ritmo estão disponíveis para a variável [!UICONTROL Campanhas] exibições: &quot;[!UICONTROL OTS de ontem]&quot; (na utilização do target), &quot;[!UICONTROL Entrega de ontem],&quot;[!UICONTROL O objetivo de ontem],&quot;[!UICONTROL O OTS de hoje]&quot; (na utilização do target), &quot;[!UICONTROL Entrega de hoje],&quot; e &quot;[!UICONTROL O objetivo de hoje].&quot; |
