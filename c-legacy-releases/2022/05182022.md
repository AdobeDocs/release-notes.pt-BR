...
* [[!DNL Experience League] eventos](#events) (atualizado em **27 de maio**)
...
| Recurso | Descrição |
| ------- | ----------- |
| Analytics para o Advertising Cloud | Se a sua empresa deseja mudar da biblioteca de `visitorAPI.js` herdada do Adobe Analytics para a biblioteca da Adobe Experience Platform (`alloy.js`) para coleção de dados, será necessário fazer algumas alterações para habilitar a unificação de ID. Consulte [Usar a biblioteca JavaScript do último serviço de evento com o SDK da Web da Adobe Experience Platform](https://experienceleague.adobe.com/docs/advertising-cloud/integrations/analytics/planning/web-sdk.html?lang=pt-BR). |
