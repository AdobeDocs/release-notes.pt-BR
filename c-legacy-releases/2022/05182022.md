...
| Maio de 2022 | [Analisar e visualizar insights omnicanal no Tableau usando o Serviço de consulta](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/analyze-and-visualize.html?lang=pt-BR) | Vídeo | Saiba como você pode usar o Serviço de query do Adobe Experience Platform com ferramentas externas de visualização de dados usando um exemplo de análise de churn. | Experience Platform |
