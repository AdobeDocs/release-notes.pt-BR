...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Junho de 2022 | [linktext](https://experienceleague.adobe.com/?lang=pt-br&recommended=Target-D-1-2021.1&amp;lang=pt-BR) | Curso | Saiba como implementar o Adobe Target em seu site. Começando com tópicos administrativos, incluindo requisitos e permissões de usuário, o curso aborda métodos de implementação, considerações e práticas recomendadas. |
