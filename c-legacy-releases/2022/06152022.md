...
| [!DNL Inventory Inspector] | (Versão de 29 de junho) A guia [!UICONTROL Inventário] da disposição [!UICONTROL Inspetor] agora inclui gráficos de visualização de dados personalizáveis e métricas de desempenho expandidas, como [!UICONTROL Taxa de visibilidade], [!UICONTROL Cliques] e [!UICONTROL CPM de ontem]. |
