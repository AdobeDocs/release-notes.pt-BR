...
| [!DNL Inventory Inspector] | (Versão de 29 de junho) A variável [!UICONTROL Inventário] guia da disposição [!UICONTROL Inspetor] O agora inclui gráficos de visualização de dados personalizáveis e métricas de desempenho expandidas, como [!UICONTROL Taxa de Viabilidade], [!UICONTROL Cliques]e [!UICONTROL O CPM de ontem]. |
