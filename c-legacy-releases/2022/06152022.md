...
| Publicado | Nome | Tipo | Descrição | Aplicativo |
| -----------| ---------- | ---------- | ---------- |---------- |
| Junho de 2022 | [Configurar um template da entrega](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/using-delivery-templates/configure-a-delivery-template.html?lang=pt-BR) | Vídeo | Saiba como configurar um modelo para uma entrega ad hoc. | Campaign v8 |
