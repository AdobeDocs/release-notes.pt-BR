...
| Janeiro de 2022 | [Serviço de email](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/networking/examples/email-service.html?lang=pt-BR) | Vídeo | Enviar emails de AEM as a Cloud Service configurando AEM `DefaultMailService` para usar portas avançadas de saída de rede. | AEM as a Cloud Service |
...
| Janeiro de 2022 | [Adicionar um módulo JavaScript](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/frontend-development/add-javascript-module.html?lang=pt-BR) | Vídeo | Saiba mais sobre como desenvolver um módulo JS simples que forneça a saudação &quot;Hello World&quot;. |
