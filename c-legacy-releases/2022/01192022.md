...
| ------| ----- | -----| ------ | --- |
| Janeiro de 2022 | [Implantar um template da entrega de email ad hoc](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/using-delivery-templates/deploy-ad-hoc-email-delivery-template.html?lang=pt-BR) | Vídeo | Saiba como implantar um template da entrega de email ad hoc e descubra a diferença entre uma entrega de email e um fluxo de trabalho de entrega. | Campaign v8 |
| Janeiro de 2022 | [Definir propriedades do template da entrega](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/using-delivery-templates/set-delivery-template-properties.html?lang=pt-BR) | Vídeo | Saiba como definir as propriedades do template da entrega e a explicação de cada propriedade em detalhes. | Campaign v8 |
