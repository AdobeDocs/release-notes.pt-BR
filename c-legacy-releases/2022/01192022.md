...
* Para obter as informações da versão atual, consulte [Notas de versão do Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=pt-BR).
