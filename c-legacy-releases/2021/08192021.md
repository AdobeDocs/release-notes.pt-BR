...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager as a Cloud Service Foundation**
      ...
      * A interface de replicação em árvore na do agente de replicação [!UICONTROL Distribuir] deve ser considerada obsoleta; está previsto para remoção após 30 de setembro de 2021. [Saiba mais sobre estratégias alternativas de replicação](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=pt-BR#tree-activation).
