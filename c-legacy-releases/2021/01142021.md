...
Os serviços do Experience Cloud e a documentação de administração incluem Atributos do cliente, Biblioteca de público-alvo ([!UICONTROL Pessoas] ), Ativation, gerenciamento de usuários e produtos e cookies do Experience Cloud.
...
| 22 de dezembro de 2020 | [Criar segmentos com várias entidades](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/create-multi-entity-segments.html?lang=pt-BR) | Vídeo | Saiba como criar segmentos de várias entidades no Construtor de segmentos do Adobe Experience Platform. |
...
| 26 de outubro de 2020 (atualizado) | [Assimilar dados usando o Conector de origem do Salesforce CRM](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html?lang=pt-BR) | Vídeo | O conector do Salesforce CRM Source permite agrupar facilmente os dados do Salesforce CRM no Adobe Experience Platform Real-time Customer Profile e Experience Data Lake, de forma contínua e escalável. |
| 13 de outubro de 2020 (atualizado) | [Assimilar dados usando o Conector de origem do Salesforce CRM](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=pt-BR) | Vídeo | O conector do Salesforce CRM Source permite agrupar facilmente os dados do Salesforce CRM no Adobe Experience Platform Real-time Customer Profile e Experience Data Lake, de forma contínua e escalável. |
...
O Experience Manager 6.4, Service Pack 8, Cumulative Fix Pack 3 (6.4.8.3 lançado 26 de novembro de 2020) é uma atualização importante que inclui várias correções internas e de clientes desde a disponibilização geral do Experience Manager 6.4, Service Pack 8 (6.4.8.0), em março de 2020.
...
Consulte [Experiência unificada](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=pt-BR#benefits) para saber mais sobre este plug-in.
      * O Conversor de Índice é um utilitário que pode ser usado para transformar as Definições de Índice OAK Personalizado de um cliente em Definições de Índice OAK Experience Manager as a Cloud Service e compatíveis.
...
* **Best Practices Analyzer**
   ...
   * [!UICONTROL O Cloud Readiness Analyzer] agora é o [!UICONTROL Best Practices Analyzer] (BPA). O BPA fornece uma avaliação das práticas recomendadas da implementação atual do Experience Manager e ajuda a avaliar a prontidão para migrar de uma instância de AEM existente para o AEM como uma [!UICONTROL Cloud Service].
...
| 9 de dezembro de 2020 | [Compatibilidade de API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/developer-reference-material-apis.html?lang=pt-BR) | Artigo | Crie um artigo simples que comunique claramente quais APIs de AEM (npm, Java™, HTTP) podem ser usadas para vários [!UICONTROL Ativos] operações. |
...
| 18 de dezembro de 2020 | [Criação de entregas de correspondência direta](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/direct-mail/creating-direct-mail-deliveries.html?lang=en) | Campaign Classic | (Vídeo) Saiba como criar uma entrega de correspondência direta e usar seed addresses em uma campanha. |
...
| Recurso | Descrição |
| -----------| ---------- |
| Novo Ajuda | (Versão de 28 de outubro) A ajuda herdada foi substituída por páginas atualizadas, que estão disponíveis no link Ajuda no menu principal DSP e também estão sempre disponíveis em [https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html?lang=pt-BR) |
...
| 29 de dezembro de 2020 | [Criar formulários preenchíveis](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/getting-started/create-fillable-forms.html?lang=pt-BR) | Artigo | Transforme um formulário ou documento digitalizado em papel criado no InDesign, Microsoft® Word ou Excel ou outro aplicativo em um formulário PDF que pode ser preenchido. |
