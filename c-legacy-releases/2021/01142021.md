...
O Pacote de serviços 7 do Experience Manager 6.5 (versão 6.5.7.0 lançada em 26 de novembro de 2020) é uma atualização importante que inclui novos recursos, melhorias essenciais para o cliente, melhor desempenho, estabilidade e segurança, e foi lançado desde a disponibilização geral do Experience Manager 6.5, em abril de 2019.
...
O Pacote de serviços 8 do Experience Manager 6.4 com o Pacote de correções cumulativo 3 (versão 6.4.8.3 lançada em 26 de novembro de 2020) é uma atualização importante que inclui várias correções internas e de cliente desde a disponibilidade geral do Pacote de serviços 8 do Experience Manager 6.4 (6.4.8.0), em março de 2020.
...
| Recurso | Descrição |
| -----------| ---------- |
| [!UICONTROL Campanhas de pesquisa] | Na visualização [!UICONTROL Contas], a coluna [!UICONTROL Acesso] agora indica quando o [!DNL Advertising Search] não consegue fazer logon em uma conta de mecanismo de pesquisa ativada. Para ver a causa do erro, mantenha o cursor sobre o ícone de aviso. |
