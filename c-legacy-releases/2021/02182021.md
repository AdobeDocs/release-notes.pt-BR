...
[A documentação de serviços e administração da Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=pt-BR) inclui Atributos do cliente, Biblioteca de público (serviço de [!UICONTROL Pessoas]), Activation, gerenciamento de usuário e produto e cookies da Experience Cloud.
