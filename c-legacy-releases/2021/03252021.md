...
| 3 de março de 2021 | [Noções básicas de características na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.html?lang=pt-BR#other-integrations) | Vídeo | Conheça as características no Audience Manager e o equivalente na Real-time CDP. |
