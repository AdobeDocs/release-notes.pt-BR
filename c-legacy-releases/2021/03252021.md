...
As atualizações mais recentes do Status de sistema da Adobe são encontradas em [Status de sistema da Adobe - 21 de maio de 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html?lang=pt-BR).
...
| ----------- | ---------- | ------- |
| Atualizações da API de reparo de dados | 25 de março de 2021 | A API de reparo de dados agora é compatível com variáveis padrão, incluindo [!UICONTROL Página] e [!UICONTROL Endereço IP] e variáveis móveis e de vídeo, assim como [!UICONTROL props] e [!UICONTROL eVars] personalizadas.  Os valores em variáveis podem ser excluídos ou novos valores podem ser definidos. A API agora também oferece filtragem de URLs, sequências de consulta, sinais e muito mais. |
...
| 17 de março de 2021 | [Compreensão de sinais na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-signals-for-aam-users.html?lang=pt-BR) | Vídeo | Este vídeo destina-se aos usuários do Audience Manager que estão migrando para a Real-time Customer Data Platform (Real-time CDP) e discute como os sinais (pares de valores chave) usados no Audience Manager para criar características são usados na plataforma. |
...
| 3 de março de 2021 | [Noções básicas de características na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.html#other-integrations) | Vídeo | Conheça as características no Audience Manager e o equivalente na Real-time CDP. |
...
| 1 de março de 2021 | [Comercializar seus próprios públicos oferecendo no Audience Marketplace](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/audience-marketplace/selling-data/commercialize-owned-audiences-on-marketplace.html#audience-marketplace) | Vídeo | Saiba como configurar seus dados como um feed de dados privado ou público no Audience Marketplace, tornando-o um provedor de dados de terceiros. |
...
| 23 de fevereiro de 2021 | [Capacidade de entrega - Processo de transição: Critérios de direcionamento](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/targeting-criteria.html?lang=pt-BR) | Campaign Classic/Standard | Saiba como estabelecer uma reputação positiva desde o início para criar confiança com eficiência antes de alcançar seus públicos menos envolvidos. |
...
Consulte as [!DNL Marketo Engage] [notas de versão](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) para obter as informações mais recentes.
