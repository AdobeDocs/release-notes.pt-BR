...
| 5 de março de 2021 | [Noções básicas sobre assimilação de dados](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/understanding-data-ingestion.html?lang=pt-BR#data-ingestion) | Vídeo | Saiba mais sobre os recursos de assimilação de dados da Experience Platform que permitem reunir os dados em uma plataforma aberta e dimensionável para gerenciar perfis de clientes em tempo real. |

## ![Ícone](/assets/experience_platform_appicon_24.png) Journey Orchestration {#journey-orch}

Use a Adobe Experience Platform para orquestrar uma jornada de cliente em escala nos canais de experiência, prevendo de forma inteligente as necessidades de cada indivíduo em tempo real.
...
| 3 de março de 2021 | [Noções básicas da assimilação de dados primários na Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-1pd-ingestion-for-aam-users.html#other-integrations) | Vídeo | Saiba mais sobre a assimilação de dados offline primários na Real-time Customer Data Platform (Real-time CDP). Conheça algumas das principais diferenças entre os dois produtos em relação à assimilação de dados e como o Conector de dados do Audience Manager pode ser usado como uma solução temporária até que os processos tenham sido transferidos para a Real-time CDP. |
