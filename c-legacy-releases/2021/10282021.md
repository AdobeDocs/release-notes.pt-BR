...
| Novembro de 2021 | [Usar APIs SOAP em fluxos de trabalho](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html) | Tutoriais em vídeo | Saiba como usar as APIs Soap do Adobe Campaign e criar um fluxo de trabalho de delivery avançado com base nos dados recebidos por meio da API. | Campaign V8 |
