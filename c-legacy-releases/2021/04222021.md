...
| Inventário privado | (Versão de 15 de outubro) Todos os usuários agora podem configurar e editar informações da ID de negócios usando um novo formulário, que é uma versão simplificada do formulário antigo de Veiculação de anúncios inteligentes. Para configurar os detalhes da ID da nova negociação, acesse **[!UICONTROL Inventário]** > **[!UICONTROL Contratos]** > **[!UICONTROL Criar]**, em seguida selecione **[!UICONTROL ID de contrato Beta]**. |
