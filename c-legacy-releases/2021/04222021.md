...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Abril de 2021 | [Compreensão da Real-time CDP para usuários do Audience Manager](https://experienceleague.adobe.com/?recommended=AudienceManager-U-1-2020.1.rtcdp&amp;lang=pt-BR) | Curso | Os clientes do Audience Manager estão reimaginando a gestão de conteúdo migrando para a Real-time Customer Data Platform (Real-time CDP) da Adobe. Este curso adota uma abordagem conceito a conceito, ajudando os usuários do Audience Manager a entender como esses conceitos são tratados na Real-time CDP. |
