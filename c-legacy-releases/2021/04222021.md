...
| Abril de 2021 | [Controle sua experiência online com PDF e colete análises](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=pt-BR) | Artigo | Sua organização publica PDFs no seu site? Saiba como usar a API incorporada do Adobe PDF para controlar a aparência, ativar a colaboração e coletar análises sobre como os usuários interagem com PDFs, incluindo o tempo gasto em uma página e pesquisas. |
