...
| Setembro de 2021 | [Monitorar bancos de dados](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/performance-monitoring/monitor-databases.html?lang=pt-BR) | Campaign V8 | Saiba como monitorar o uso do banco de dados das instâncias com o [!UICONTROL Painel de controle do Campaign]. |
| Setembro de 2021 | [Lista de permissões de endereços IP](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/instance-settings/allowlist-ip-address.html?lang=pt-BR) | Campaign V8 | Saiba como adicionar um intervalo IP às lista de permissões de instâncias do Campaign Classic e como removê-las da lista de permissões usando o [!UICONTROL Painel de controle do Campaign]. |
| Setembro de 2021 | [Lista de permissões de intervalos IP](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/allowlist-ip-range.html?lang=pt-BR) | Campaign V8 | Saiba como adicionar um intervalo de endereços IP à lista de permissões no [!UICONTROL Painel de controle do Campaign]. |
...
| Setembro de 2021 | [Gerar uma chave SSH](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/generate-ssh-key.html?lang=pt-BR) | Campaign V8 | Saiba como gerar uma chave SSH usando um terminal e como armazenar a versão pública da chave no [!UICONTROL Painel de controle do Campaign]. |
| Setembro de 2021 | [Painel de controle do Campaign - Monitorar a capacidade do servidor](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/monitor-server-capacity.html?lang=pt-BR) | Campaign V8 | Saiba como monitorar a capacidade de armazenamento dos servidores SFTP. |
| Setembro de 2021 | [Painel de controle do Campaign - Introdução ao Painel de controle do Campaign](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/get-started.html?lang=pt-BR) | Campaign V8 | Este artigo explica como acessar o [!UICONTROL Painel de controle do Campaign] e quais pré-requisitos podem funcionar com o [!UICONTROL Painel de controle do Campaign]. |
