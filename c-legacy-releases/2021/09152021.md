...
| -----------| ---------- | ---------- | ---------- |
| 23 de setembro de 2021 | [Dicas de especialistas para fazer suas campanhas de fim de ano se destacarem](https://www.youtube.com/channel/UCN-7ZEctit8Qu01BWeHQ0Fw) | Evento de vídeo ao vivo | Assim como nunca é cedo demais para começar suas compras de férias, nunca é cedo demais para começar a planejar uma campanha de marketing de feriados bem-sucedida. Com o Adobe Campaign, você pode criar, planejar e executar campanhas que façam com que todos os desejos de feriados de sua organização se realizem.<br>Mas você conhece todas as dicas para veicular campanhas que encerram o ano em alta? Junte-se a nós para uma discussão ao vivo com três especialistas da Adobe que têm muita experiência coletiva em fazer exatamente isso. [Detalhes...](https://www.youtube.com/watch?v=bsU1lAv0xes) |
...
| Setembro de 2021 | [Exibir métricas de desempenho do Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/view-analysis-workspace-performance-metrics.html?lang=pt-BR) | Vídeo | Vários fatores podem influenciar o desempenho de um projeto no Analysis Workspace. Usar o [!UICONTROL Desempenho] , você pode ver fatores que afetam o desempenho do seu projeto, incluindo fatores de rede, navegador e projeto. |
...
| Setembro de 2021 | [Vinculação em tempo real do gráfico Dimension no Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/dimension-graph-live-linking.html?lang=pt-BR) | Vídeo | Não sabemos bem como chamar isso, mas é legal! Ao criar um gráfico de linhas de um valor de dimensão, agora é possível selecionar valores de dimensão diferentes e alterar o gráfico dinamicamente. Assista ao vídeo para saber mais. |
...
|  | (Versão de 8 de setembro) Usuários com o &quot;[!DNL FreeWheel Programmatic Guaranteed]&quot;agora, a permissão pode enviar um anúncio para a [!DNL FreeWheel Programmatic Creative API] do [!UICONTROL Anúncios] ou a [!UICONTROL Posicionamentos] exibir. Você ainda pode enviar um anúncio da exibição de [!UICONTROL Contratos]. |
