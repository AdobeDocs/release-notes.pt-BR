...
* Adição do [código de erro do sistema DCS 10](https://experienceleague.adobe.com/docs/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-error-codes.html#system-error-codes), indicando se as características na solicitação foram parcialmente avaliadas ou se não foram avaliadas.
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Os administradores podem configurar o Experience Manager para excluir a origem de ativos depois de fazer uma assimilação de ativos em massa. Consulte [assimilação de ativos em massa](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
...
Consulte as [notas de versão](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) do [!DNL Marketo Engage] para obter as informações da programação de lançamento mais recente.
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Maio de 2021 | [Controle sua experiência online com PDF e colete análises](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=pt-BR#part1) | Artigo | Saiba como usar a API incorporada do Adobe PDF para controlar a aparência, ativar a colaboração e coletar análises sobre como os usuários interagem com PDFs, incluindo o tempo gasto em uma página e pesquisas. (Quatro partes.) |
