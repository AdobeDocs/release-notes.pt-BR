...
| Maio de 2021 | [Definição das configurações de componente nas Visualizações de dados](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/configuring-component-settings-in-data-views.html?lang=pt-BR) | Vídeo | Saiba mais sobre as configurações básicas do componente que deseja configurar para cada um dos componentes (métricas e dimensões) ao configurar um [!UICONTROL Exibição de dados] em Customer Journey Analytics. |
...
| Recurso | Descrição |
| -----------| ---------- |
| Configurações de pacote | Uma nova opção [!UICONTROL Estratégia de preenchimento de pacote], &quot;[!UICONTROL Ligeiramente à frente]&quot;, está disponível e é o padrão para novos pacotes. Essa estratégia acelera a entrega para que esteja 55 a 65% completa na metade da duração do voo. |
...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Maio de 2021 | [Controle sua experiência online com PDF e colete análises](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=pt-BR#part1) | Artigo | Saiba como usar a API do Adobe PDF Embed para controlar a aparência, ativar a colaboração e coletar análises sobre como o usuário interage com o PDF, incluindo o tempo gasto em uma página e pesquisas. (Quatro partes.) |
