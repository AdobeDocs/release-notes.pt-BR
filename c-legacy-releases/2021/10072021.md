...
| Navegação do Experience Cloud [!UICONTROL Triggers] | O [Experience Cloud Triggers](https://experienceleague.adobe.com/docs/core-services/interface/services/triggers.html) está disponível para navegação direta a partir do alternador do aplicativo no cabeçalho para usuários provisionados. |
