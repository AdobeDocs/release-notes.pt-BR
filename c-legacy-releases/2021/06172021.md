...
| Publicado | Nome | Tipo | Descrição |
| -----------| ---------- | ---------- | ---------- |
| Junho de 2021 | [Introdução ao Customer Journey Analytics para administradores](https://experienceleague.adobe.com/?lang=pt-br&recommended=CustomerJourneyAnalytics-A-1-2020.1&amp;lang=pt-BR) | Curso | Saiba como ajustar, configurar e administrar o Customer Journey Analytics. Saiba mais sobre alguns conceitos básicos para estabelecer uma base e depois confira mais etapas de configuração. O curso se encerra com algumas recomendações sobre como migrar métricas calculadas e segmentos do Adobe Analytics para o Customer Journey Analytics. |
