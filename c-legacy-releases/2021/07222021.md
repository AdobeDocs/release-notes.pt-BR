...
* **Experience Manager as a Cloud Service**
   ...
   * **Guias Experience Manager as a Cloud Service**

      * **Sistema de gerenciamento de conteúdo de componentes nativos em nuvem** - Guias de Experience Manager está disponível as a Cloud Service. Obtenha o ambiente que permite criar, gerenciar e enviar documentação e conteúdo em escala.
      ...
      * **Nova aparência para o editor da Web** — nova aparência com alterações na interface, tornando-a mais intuitiva. A arquitetura subjacente foi alterada de coral para espectro baseado em reação.
      ...
      Visita [Guias Experience Manager](https://www.adobe.com/products/xml-documentation-for-experience-manager.html) para obter mais informações.
