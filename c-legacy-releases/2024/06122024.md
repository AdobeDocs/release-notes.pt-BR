...
* **WORKFRONT** | Workshop do cliente | _Princípios de administração – Introdução ao Workfront_ | Novo no Workfront? Junte-se às nossas reuniões mensais de “Novos administradores” para fazer perguntas, obter recursos e recomendações, conhecer outros novos administradores e, nesta sessão, saber mais sobre as práticas recomendadas para configurar o seu ambiente do Workfront. |**9 de julho às 09:00 MT** | [Inscreva-se](https://events.teams.microsoft.com/event/49c249c9-81d9-4a54-a0cb-6d6313ed429c@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
