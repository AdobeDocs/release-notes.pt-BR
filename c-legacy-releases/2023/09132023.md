...
| Agosto de 2023 | [[!DNL Adobe Experience Manager Forms]: como alterar [!DNL JBoss®] caminho do log?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22689.html?lang=pt-BR) | Novo artigo | Saiba como alterar o caminho do log do [!DNL JBoss®] em um ambiente do [!DNL Windows Server] no [!DNL AEM Forms]. |
...
| Agosto de 2023 | [[!DNL GraphQL API] in [!DNL AEMaaCS] não é extensível](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22619.html?lang=pt-BR) | Novo artigo | Saiba mais sobre o problema da [!DNL GraphQL API] no [!DNL AEMaaCS] não ser extensível. |
