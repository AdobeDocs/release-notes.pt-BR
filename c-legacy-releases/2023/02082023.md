...
>[!IMPORTANT]
>
>A Adobe recomenda [atualizar para a versão mais recente (1.9.6)](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html) do conector aprimorado do [!DNL Workfront] for Experience Manager.
