...
Use Formulários adaptáveis headless para permitir que seus desenvolvedores criem, publiquem e gerenciem formulários interativos que podem ser acessados e manuseados por meio de APIs, em vez de utilizar uma interface gráfica tradicional. Os formulários adaptáveis headless ajudam a:
...
| Maio de 2023 | [Demonstração completa do [!UICONTROL Live Search]](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/capabilities/live-search-full-demonstration.html?lang=en) | Vídeo | Assista a uma demonstração completa dos recursos e da flexibilidade do [!UICONTROL Live Search]. |
