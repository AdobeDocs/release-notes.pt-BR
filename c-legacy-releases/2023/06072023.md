...
# Notas de versão do Experience Cloud - junho de 2023
...
Assista ao [Vídeo de visão geral da versão de fevereiro de 2023](https://video.tv.adobe.com/v/3416885) para obter um resumo dos recursos adicionados à versão 2023.02.0 (fevereiro de 2023). <!-- OLD. UPDATE ON JUNE 7 -->
...
* Adição de suporte para imagens WebP para extrair metadados automaticamente e gerar miniaturas e representações personalizadas. Os recursos de Tag inteligente e Recorte inteligente agora também são compatíveis com esses arquivos.<!-- OLD. UPDATE FOR JUNE 7 -->
...
* Ao configurar pastas vinculadas ao projeto com o AEM 6.4, o [!DNL Experience Manager] não salva os valores de **subpastas** e campos **Criar pasta vinculada em projetos com portfólio**. O valor do campo **subpastas** é atualizado para **indefinido**. O valor para a variável **Criar pasta vinculada em projetos com portfólio** atualizações de campo para **Portfolio padrão** automaticamente após salvar a configuração. <!-- NEW. LEAVE IN FOR JUNE 7 -->
* Ao usar a experiência clássica do Workfront, a opção **Enviar para** disponível na lista suspensa **Mais** não permite selecionar o destino no Experience Manager. A opção **Enviar para** funciona corretamente usando a lista suspensa **Ações do documento**. A variável **Enviar para** A opção funciona corretamente para **Mais** lista suspensa e a variável **Ações do documento** disponível na nova experiência do Workfront.<!-- NEW. LEAVE IN FOR JUNE 7 -->
