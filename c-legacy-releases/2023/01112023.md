...
| Janeiro de 2023 | [Usar filtros (tags)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/using-filters-tags-in-the-left-rail.html?lang=pt-BR) | Vídeo atualizado | Saiba como usar filtros, chamados de tags, no Analysis Workspace. Essas técnicas economizam tempo para ajudar você a criar seu projeto com eficiência. |
...
| Janeiro de 2023 | [Usar atalhos de teclado](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/keyboard-shortcuts.html?lang=pt-BR) | Vídeo atualizado | Saiba como usar atalhos de teclado no Analysis Workspace. Essas técnicas economizam tempo para ajudar você a executar várias tarefas em um projeto. |
